          ...
          <main className="max-w-3xl px-4 py-24 mx-auto">
            ...
            <div className="space-y-6" data-testid="event-types">
              {eventTypes.map((type) => (
                <div
                  key={type.id}
                  className="relative bg-white border rounded-sm group dark:bg-neutral-900 dark:border-0 dark:hover:border-neutral-600 dark:hover:bg-gray-800 hover:bg-gray-50 border-neutral-200 hover:border-brand">
