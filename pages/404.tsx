  ...
  return (
    <>
      ...
      <div className="px-4 min-h-screen bg-white">
        <main className="mx-auto pb-6 pt-16 max-w-xl sm:pt-24">
          <div className="text-center">
            <p className="text-black text-sm font-semibold tracking-wide uppercase">404 error</p>
          ...
          <div className="mt-12">
            <h2 className="text-gray-500 text-sm font-semibold tracking-wide uppercase">Popular pages</h2>
              ...
              <li className="px-4 py-2 border-2 border-green-500">
                <a href="https://checkout.calendso.com" className="relative flex items-start py-6 space-x-4">
                  <div className="flex-shrink-0">
                    <span className="flex items-center justify-center w-12 h-12 bg-green-50 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 text-base">Claim your username and schedule events</p>
                  </div>
            ...
            <ul role="list" className="mt-4 border-gray-200 divide-gray-200 divide-y">
              {links.map((link, linkIdx) => (
                <li key={linkIdx} className="px-4 py-2">
                  <Link href={link.href}>
                    <a className="relative flex items-start py-6 space-x-4">
                      <div className="flex-shrink-0">
                        <span className="flex items-center justify-center w-12 h-12 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-500 text-base">{link.description}</p>
                      </div>
                      <div className="flex-shrink-0 self-center">
                        <ChevronRightIcon className="w-5 h-5 text-gray-400" aria-hidden="true" />
                      </div>
              ...
              <li className="px-4 py-2">
                <a href="https://calendso.com/slack" className="relative flex items-start py-6 space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 text-base">Join our community</p>
                  </div>
                  <div className="flex-shrink-0 self-center">
                    <ChevronRightIcon className="w-5 h-5 text-gray-400" aria-hidden="true" />
                  </div>
            ...
            <div className="mt-8">
              <Link href="/">
                <a className="text-black hover:text-gray-500 text-base font-medium">
