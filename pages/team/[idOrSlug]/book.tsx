...
import { EventTypeCustomInputType, EventType } from "@prisma/client";
          ...
          <div className="sm:flex px-4 py-5 sm:p-4">
            <div className="sm:w-1/2 sm:border-r sm:dark:border-black">
              <ul className="flex flex-inline">
                ...
                {props.eventType.organizers.map((organizer, idx: number) => (
                  <li key={organizer.id} className={idx !== 0 ? "-ml-3" : ""}>
                    <Avatar
