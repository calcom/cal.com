...
export default function Teams() {
  ...
  return (
    <Shell
      headingId="teams"
      heading="Teams"
      subtitleId="createAndManageTeams"
      subtitle="Create and manage teams to use collaborative features.">
      <SettingsShell>
        {!editTeamEnabled && (
              ...
              <div className="flex flex-col justify-between md:flex-row">
                ...
                <div className="flex items-start mb-4">
                  <Button
                    ...
                    <FormattedMessage id="newTeam" defaultMessage="New Team" />
                  </Button>
                </div>
              </div>
              <div>
                ...
                <div className="mb-4 sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg font-medium leading-6 text-gray-900" id="modal-title">
                      <FormattedMessage id="createNewTeam" defaultMessage="Create a new team" />
                    </h3>
                    <div>
                ...
                <form onSubmit={createTeam}>
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <button type="submit" className="btn btn-primary">
                      <FormattedMessage id="createTeam" defaultMessage="Create team" />
                    </button>
                    <button
