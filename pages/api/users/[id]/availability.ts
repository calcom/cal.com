// import availability from "@calcom/core/availability";
...
import { asNumberOrThrow, asStringOrNull } from "@calcom/lib/asStringOrNull";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  const { prisma } = req;
  const id = asNumberOrThrow(req.query.id);
