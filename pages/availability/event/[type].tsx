                                ...
                                <form onSubmit={updateEventTypeHandler}>
                                        ...
                                        {locations.length > 0 && <ul className="w-96 mt-1">
                                                    ...
                                                    <div className="flex justify-between">
                                                        {location.type === LocationType.InPerson && (
                                                            <div className="flex-grow flex">
                                                                ...
                                                                <span className="mis-2 text-sm">{location.address}</span>
                                                            </div>
                                                        )}
                                                        {location.type === LocationType.Phone && (
                                                            <div className="flex-grow flex">
                                                                <PhoneIcon className="h-6 w-6" />
                                                                <span className="mis-2 text-sm">Phone call</span>
                                                            </div>
                                                        )}
                                                        <div className="flex">
                                                            <button type="button" onClick={() => openLocationModal(location.type)} className="mie-2 text-sm text-blue-600">Edit</button>
                                                            <button onClick={() => removeLocation(location)}>
                                                                <XIcon className="h-6 w-6 border-l-2 pis-1 hover:text-red-500 " />
                                                            </button>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            {locations.length > 0 && locations.length !== locationOptions.length && <li>
                                                <button type="button" className="sm:flex sm:items-start text-sm text-blue-600" onClick={() => setShowLocationModal(true)}>
                                                    ...
                                                    <span className="mis-1">Add another location option</span>
                                                </button>
                                            </li>}
                                        </ul>}
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="mt-1 relative rounded-md shadow-sm">
                                            <input ref={lengthRef} type="number" name="length" id="length" required className="focus:ring-blue-500 focus:border-blue-500 block w-full pie-20 sm:text-sm border-gray-300 rounded-md" placeholder="15" defaultValue={props.eventType.length} />
                                    ...
                                    <Link href="/availability"><a className="mis-2 btn btn-white">Cancel</a></Link>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                {showLocationModal &&
                    <div className="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-start shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                ...
                                <form onSubmit={updateLocations}>
                                    ...
                                    <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button onClick={closeLocationModal} type="button" className="btn btn-white mie-2">
                                            Cancel
                                        </button>
                                    </div>
                                </form>
