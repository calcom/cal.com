        ...
        {showChangeTimesModal && (
          <div
            ...
            <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-sm shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                ...
                <form onSubmit={updateStartEndTimesHandler}>
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    ...
                    <button onClick={toggleChangeTimesModal} type="button" className="mr-2 btn btn-white">
                      Cancel
                    </button>
                  </div>
                </form>
