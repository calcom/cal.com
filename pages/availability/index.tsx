      ...
      <Shell heading="Availability">
        <div className="mb-4 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-3 sm:mt-0 sm:ml-4">
            <Dialog.Root open={showAddNewEventModal} onOpenChange={setShowAddNewEventModal}>
              <Dialog.Overlay className="fixed z-10 inset-0 bg-gray-500 bg-opacity-75 transition-opacity" />
              <Dialog.Trigger className="btn-sm btn-white">New event type</Dialog.Trigger>
              <Dialog.Content className="fixed bottom-20 sm:top-1/2 left-1/2 transform -translate-x-1/2 w-11/12 max-w-max bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transition-all sm:max-w-lg sm:w-full sm:bottom-auto sm:-translate-y-1/2">
                ...
                <form onSubmit={createEventTypeHandler}>
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    ...
                    <Dialog.Close className="btn btn-white mr-2">Cancel</Dialog.Close>
                  </div>
                </form>
              </Dialog.Content>
            </Dialog.Root>
        ...
        <div className="flex">
          <div className="w-1/2 mr-2 bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <Dialog.Root open={showChangeTimesModal} onOpenChange={setShowChangeTimesModal}>
                <Dialog.Overlay className="fixed z-10 inset-0 bg-gray-500 bg-opacity-75 transition-opacity" />
                <div className="mt-5">
                  <Dialog.Trigger className="btn btn-primary">Change available times</Dialog.Trigger>
                </div>
                <Dialog.Content className="fixed bottom-20 sm:top-1/2 left-1/2 transform -translate-x-1/2 w-11/12 max-w-max bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transition-all sm:max-w-lg sm:w-full sm:bottom-auto sm:-translate-y-1/2">
                  <div className="sm:flex sm:items-start mb-4">
                    <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
