                                        ...
                                        {props.types.map((eventType) =>
                                            <tr>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                    {eventType.title}
                                                    {eventType.hidden &&
                                                        <span className="mis-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                                                            Hidden
                                                        </span>
                                                    }
                                                </td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                    <Link href={"/" + props.user.username + "/" + eventType.slug}><a target="_blank" className="text-blue-600 hover:text-blue-900 mie-2">View</a></Link>
                            ...
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-start overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                ...
                                <form onSubmit={createEventTypeHandler}>
                                    <div>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="mt-1 relative rounded-md shadow-sm">
                                                <input ref={lengthRef} type="number" name="length" id="length" required className="focus:ring-blue-500 focus:border-blue-500 block w-full pie-20 sm:text-sm border-gray-300 rounded-md" placeholder="15" />
                                                <div className="absolute inset-y-0 right-0 pie-3 flex items-center text-gray-400 text-sm">
                                                    minutes
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button onClick={toggleAddModal} type="button" className="btn btn-white mie-2">
                                            Cancel
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-start overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                ...
                                <form onSubmit={updateStartEndTimesHandler}>
                                    ...
                                    <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button onClick={toggleChangeTimesModal} type="button" className="btn btn-white mie-2">
                                            Cancel
                                        </button>
                                    </div>
                                </form>
