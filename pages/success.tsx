  ...
  return (
    isReady && (
      <div className="h-screen bg-neutral-50 dark:bg-neutral-900">
        ...
        <main className="mx-auto py-24 max-w-3xl">
          <div className="fixed z-50 inset-0 overflow-y-auto">
            <div className="flex items-end justify-center pb-20 pt-4 px-4 min-h-screen text-center sm:block sm:p-0">
              <div className="fixed inset-0 my-4 transition-opacity sm:my-0" aria-hidden="true">
                ...
                <div
                  className="inline-block align-bottom pb-4 pt-5 px-8 text-left dark:bg-gray-800 bg-white border border-neutral-200 dark:border-neutral-700 rounded-sm overflow-hidden transform transition-all sm:align-middle sm:my-8 sm:py-6 sm:w-full sm:max-w-lg"
                  role="dialog"
                  aria-modal="true"
                  ...
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      <h3
                        className="text-neutral-900 dark:text-white text-2xl font-semibold leading-6"
                        id="modal-headline">
                        {props.eventType.requiresConfirmation ? "Submitted" : "This meeting is scheduled"}
                      </h3>
                      <div className="mt-3">
                        <p className="dark:text-gray-300 text-neutral-600 text-sm">
                          {props.eventType.requiresConfirmation
                            ? `${
                      ...
                      <div className="grid grid-cols-3 mt-4 py-4 text-left dark:text-gray-300 text-gray-700 border-b border-t dark:border-gray-900">
                  ...
                  {!props.eventType.requiresConfirmation && (
                    <div className="flex mt-5 pt-2 text-center sm:mt-0 sm:pt-4">
                      <span className="flex self-center mr-6 dark:text-gray-50 text-gray-700 font-medium">
                        Add to calendar
                      </span>
                      <div className="flex">
                        <Link
                          ...
                          <a className="mx-2 px-3 py-2 dark:text-white border border-neutral-200 dark:border-neutral-700 rounded-sm">
                            <svg
                        ...
                        <Link
                          ...
                          <a
                            className="mx-2 px-3 py-2 dark:text-white border border-neutral-200 dark:border-neutral-700 rounded-sm"
                            target="_blank">
                            <svg
                  ...
                  {!props.user.hideBranding && (
                    <div className="mt-4 pt-4 text-center text-gray-400 dark:text-white text-xs border-t dark:border-gray-900">
