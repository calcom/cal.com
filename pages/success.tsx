                ...
                <div
                  ...
                  {!props.hideBranding && (
                    <div className="pt-4 text-xs text-center text-gray-400 dark:border-gray-900 dark:text-white">
                      <a href="https://www.theskills.com/talent">{t("create_booking_link_with_calcom")}</a>

                      <form
                        onSubmit={(e) => {
                          e.preventDefault();
                          router.push(`https://www.theskills.com/talent` + (e as any).target.email.value);
                        }}
                        className="flex mt-4">
                        <input
                          type="email"
                          ...
                          placeholder="jane.doe@theskills.com"
                        />
