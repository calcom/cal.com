                    ...
                    <div className="pt-4 text-xs text-center text-gray-400 dark:border-gray-900 dark:text-white">
                      ...
                      <form
                        ...
                        <input
                          ...
                          className="block w-full text-gray-600 border-gray-300 shadow-sm dark:bg-brand dark:text-brandtext dark:border-gray-900 focus:ring-black focus:border-brand sm:text-sm"
