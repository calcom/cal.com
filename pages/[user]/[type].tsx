        ...
        >
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="sm:flex px-4 py-5 sm:p-4">
              <div
                className={
                  "pie-8 sm:border-r " + (selectedDate ? "sm:w-1/3" : "sm:w-1/2")
                }
              >
                ...
                >
                  <GlobeIcon className="inline-block w-4 h-4 mie-1 -mt-1" />
                  {selectedTimeZone}
                  <ChevronDownIcon className="inline-block w-4 h-4 mis-1 -mt-1" />
                </button>
                {isTimeOptionsOpen && (
                  <div className="w-full rounded shadow border bg-white px-4 py-2">
                    <div className="flex mb-4">
                      ...
                      <div className="w-1/2">
                        ...
                        >
                          <Switch.Label as="span" className="mie-3">
                          ...
                          <Switch.Label as="span" className="mis-3">
              ...
              >
                <div className="flex text-gray-600 font-light text-xl mb-4 mis-2">
              ...
              {selectedDate && (
                <div className="pis-4 mt-8 sm:mt-0 text-center sm:w-1/3  md:max-h-97 overflow-y-auto">
          ...
          */}
          <div className="text-xs text-end pt-1">
