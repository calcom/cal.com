                        ...
                        <span className="truncate ">
                          ...
                          <div className="flex mt-2 space-x-4">
                            <div className="flex items-center text-sm text-neutral-600">
                              <ClockIcon
                                className="flex-shrink-0 mr-1.5 h-4 w-4 text-neutral-500"
                                aria-hidden="true"
                              />
                              <p>{type.length}m</p>
                            </div>
                      ...
                      <div className="flex space-x-5 overflow-hidden">
                        <Tooltip content="Preview">
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="p-2 border border-transparent cursor-pointer hover:opacity-80 group text-neutral-400 hover:border-gray-200">
                        ...
                        <Tooltip content="Copy link">
                          <button
                            ...
                            className="p-2 border border-transparent group text-neutral-600 hover:border-gray-200">
