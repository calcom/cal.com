...
2. In the "Booking questions" section, you'll need to modify two fields:
   ...
   - Click the "Edit" button next to the Email field - Uncheck the "Required" option - Click "Save"
   ...
   - Click the "Edit" button next to the Phone number field - Check the "Required" option - Ensure "Show on booking
   page" is toggled on - Click "Save"
