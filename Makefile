...
deploy_to_staging:
	...
	@${FUJI} deploy \
		...
		--secrets DATABASE_URL=${SSM_STAGING}/DATABASE_URL,NEXTAUTH_SECRET=${SSM_STAGING}/NEXTAUTH_SECRET,CALENDSO_ENCRYPTION_KEY=${SSM_STAGING}/CALENDSO_ENCRYPTION_KEY,GOOGLE_API_CREDENTIALS=${SSM_SHARED}/GOOGLE_API_CREDENTIALS,SENDGRID_API_KEY=${SSM_SHARED}/SENDGRID_API_KEY,SENDGRID_EMAIL=${SSM_SHARED}/SENDGRID_EMAIL \
		--image ${IMAGE} \
