...
const CARD_OPTIONS = {
  ...
  classes: {
    base: "block p-2 w-full border-solid border-2 border-gray-300 rounded-md shadow-sm dark:bg-brand dark:text-brandtext dark:border-gray-900 focus-within:ring-black focus-within:border-brand sm:text-sm",
  },
  style: {
    base: {
      color: "#000",
