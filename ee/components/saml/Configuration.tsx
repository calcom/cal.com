        ...
        <>
          ...
          <form className="mt-3 divide-y divide-gray-200 lg:col-span-9" onSubmit={updateSAMLConfigHandler}>
            ...
            <div className="flex justify-end py-8">
              <button
                type="submit"
                className="ml-2 bg-gray-900 border border-transparent rounded-sm shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
                {t("save")}
              </button>
            </div>
            <hr className="mt-4" />
