...
export function EmptyScreen({
  ...
  return (
    <View
      className={`flex w-full select-none flex-col items-center justify-center rounded-lg bg-white p-7 ${className || ""}`}
    >
      <View className="h-[72px] w-[72px] items-center justify-center rounded-full bg-gray-100">
