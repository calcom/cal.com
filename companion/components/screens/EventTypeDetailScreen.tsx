...
} from "../event-type-detail/utils";
import {
  buildPartialUpdatePayload,
  hasChanges,
} from "../event-type-detail/utils/buildPartialUpdatePayload";
...
export interface EventTypeDetailScreenProps {
  id: string;
  title?: string;
  description?: string;
  duration: string;
...
export function EventTypeDetailScreen({
  id,
  title,
  description,
  duration,
