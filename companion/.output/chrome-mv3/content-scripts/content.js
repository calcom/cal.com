var content=(function(){"use strict";var Z=Object.defineProperty;var O=(w,g,v)=>g in w?Z(w,g,{enumerable:!0,configurable:!0,writable:!0,value:v}):w[g]=v;var x=(w,g,v)=>O(w,typeof g!="symbol"?g+"":g,v);var R,B;const w={matches:["<all_urls>"],main(){if(document.getElementById("cal-companion-sidebar"))return;window.location.hostname==="mail.google.com"&&q();let e=!1,n=!0;const t=document.createElement("div");t.id="cal-companion-sidebar",t.style.position="fixed",t.style.top="0",t.style.right="0",t.style.width="400px",t.style.height="100vh",t.style.zIndex="2147483647",t.style.backgroundColor="white",t.style.border="1px solid #ccc",t.style.borderTop="none",t.style.borderBottom="none",t.style.boxShadow="-2px 0 10px rgba(0,0,0,0.1)",t.style.transition="transform 0.3s ease-in-out",t.style.transform="translateX(100%)",t.style.display="none";const c=document.createElement("iframe");c.src="http://localhost:8081",c.style.width="100%",c.style.height="100%",c.style.border="none",c.style.borderRadius="0",t.appendChild(c);const r=document.createElement("div");r.id="cal-companion-buttons",r.style.position="fixed",r.style.top="20px",r.style.right="420px",r.style.display="flex",r.style.flexDirection="column",r.style.gap="8px",r.style.zIndex="2147483648",r.style.transition="right 0.3s ease-in-out",r.style.display="none";const s=document.createElement("button");s.innerHTML="◀",s.style.width="40px",s.style.height="40px",s.style.borderRadius="50%",s.style.border="none",s.style.backgroundColor="rgba(0, 0, 0, 0.5)",s.style.backdropFilter="blur(10px)",s.style.color="white",s.style.cursor="pointer",s.style.fontSize="16px",s.style.boxShadow="0 2px 8px rgba(0,0,0,0.2)",s.style.transition="all 0.2s ease",s.title="Toggle sidebar";const l=document.createElement("button");l.innerHTML=`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13 1L1 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M1 1L13 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,l.style.width="40px",l.style.height="40px",l.style.borderRadius="50%",l.style.border="none",l.style.backgroundColor="rgba(0, 0, 0, 0.5)",l.style.backdropFilter="blur(10px)",l.style.color="white",l.style.cursor="pointer",l.style.fontSize="16px",l.style.boxShadow="0 2px 8px rgba(0,0,0,0.2)",l.style.transition="all 0.2s ease",l.title="Close sidebar",s.addEventListener("mouseenter",()=>{s.style.transform="scale(1.1)"}),s.addEventListener("mouseleave",()=>{s.style.transform="scale(1)"}),l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.1)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),s.addEventListener("click",()=>{n||(e=!e,e?(t.style.transform="translateX(0)",r.style.right="420px",s.innerHTML=`<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`):(t.style.transform="translateX(100%)",r.style.right="20px",s.innerHTML=`<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`))}),l.addEventListener("click",()=>{n=!0,e=!1,t.style.display="none",r.style.display="none"}),r.appendChild(s),r.appendChild(l),document.body.appendChild(t),document.body.appendChild(r),chrome.runtime.onMessage.addListener(k=>{k.action==="icon-clicked"&&(n?(n=!1,e=!0,t.style.display="block",r.style.display="flex",t.style.transform="translateX(0)",r.style.right="420px",s.innerHTML=`<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11L6 6L1 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11L13 6L8 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`):(e=!e,e?(t.style.transform="translateX(0)",r.style.right="420px",s.innerHTML=`<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11L6 6L1 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11L13 6L8 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`):(t.style.transform="translateX(100%)",r.style.right="20px",s.innerHTML=`<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13 1L8 6L13 11" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6 1L1 6L6 11" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`)))});function q(){function k(){document.querySelectorAll('div[role="button"][data-tooltip="Send ‪(Ctrl-Enter)‬"], div[role="button"][data-tooltip*="Send"], div[role="button"][aria-label*="Send"]').forEach(N=>{var z;const C=N.closest("td");if(!C)return;const A=C.closest("tr");if(!A||((z=C.parentElement)==null?void 0:z.querySelector(".cal-companion-gmail-button"))||!(N.closest('[role="dialog"]')||N.closest(".nH")))return;const y=document.createElement("td");y.className="cal-companion-gmail-button",y.style.cssText=`
            padding: 0;
            margin: 0;
          ...
          `,h.addEventListener("mouseenter",()=>{h.style.backgroundColor="#333333",h.style.transform="scale(1.05)"}),h.addEventListener("mouseleave",()=>{h.style.backgroundColor="#000000",h.style.transform="scale(1)"}),h.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation();const a=document.querySelector(".cal-companion-gmail-menu");if(a){a.remove();return}const i=document.createElement("div");i.className="cal-companion-gmail-menu",i.style.cssText=`
            ...
            `,D(i),y.style.position="relative",y.appendChild(i),setTimeout(()=>{document.addEventListener("click",function m(d){i.contains(d.target)||(i.remove(),document.removeEventListener("click",m))})},0)});async function D(p){try{const a=await new Promise((d,M)=>{chrome.runtime.sendMessage({action:"fetch-event-types"},u=>{console.log("Raw response from background:",u),chrome.runtime.lastError?(console.log("Chrome runtime error:",chrome.runtime.lastError),M(new Error(chrome.runtime.lastError.message))):u&&u.error?(console.log("Response has error:",u.error),M(new Error(u.error))):(console.log("Resolving with response:",u),d(u))})});console.log("Final response from background script:",a);let i=[];if(a&&a.data?i=a.data:Array.isArray(a)?i=a:(console.log("Unexpected response format:",a),i=[]),Array.isArray(i)||(console.log("EventTypes is not an array:",typeof i,i),i=[]),console.log("Final eventTypes array:",i,"Length:",i.length),p.innerHTML="",i.length===0){p.innerHTML=`
                  <div style="padding: 16px; text-align: center; color: #5f6368;">
                ...
                color: #3c4043;
                font-size: 13px;
              `,m.textContent="Select an event type to share",p.appendChild(m);try{i.forEach((d,M)=>{if(!d||typeof d!="object"){console.warn("Invalid event type object:",d);return}const u=d.title||"Untitled Event",G=d.length||d.duration||30,X=d.description||"No description",f=document.createElement("div");f.style.cssText=`
                    padding: 12px 16px;
                    display: flex;
                    flex-direction: column;
                    cursor: pointer;
                    transition: background-color 0.1s ease;
                    border-bottom: ${M<i.length-1?"1px solid #e8eaed":"none"};
                  `,f.innerHTML=`
              ...
              `}}function _(p){var i,m;const a=`https://cal.com/${((m=(i=p.users)==null?void 0:i[0])==null?void 0:m.username)||"user"}/${p.slug}`;navigator.clipboard.writeText(a).then(()=>{j("Link copied to clipboard!","success")}).catch(d=>{console.error("Failed to copy link:",d),j("Failed to copy link","error")})}function j(p,a){const i=document.createElement("div");i.style.cssText=`
              position: fixed;
              top: 20px;
              right: 20px;
              padding: 12px 16px;
            ...
            `,i.textContent=p,document.body.appendChild(i),setTimeout(()=>{i.remove()},3e3)}h.title="Schedule with Cal.com",y.appendChild(h),C.nextSibling?A.insertBefore(y,C.nextSibling):A.appendChild(y)})}setTimeout(k,1e3),new MutationObserver(()=>{k()}).observe(document.body,{childList:!0,subtree:!0});let $=window.location.href;setInterval(()=>{window.location.href!==$&&($=window.location.href,setTimeout(k,500))},1e3)}}};function g(o){return o}const E=(B=(R=globalThis.browser)==null?void 0:R.runtime)!=null&&B.id?globalThis.browser:globalThis.chrome;function L(o,...e){}const V={debug:(...o)=>L(console.debug,...o),log:(...o)=>L(console.log,...o),warn:(...o)=>L(console.warn,...o),error:(...o)=>L(console.error,...o)},T=class T extends Event{constructor(e,n){super(T.EVENT_NAME,{}),this.newUrl=e,this.oldUrl=n}};x(T,"EVENT_NAME",H("wxt:locationchange"));let I=T;function H(o){var e;return`${(e=E==null?void 0:E.runtime)==null?void 0:e.id}:content:${o}`}function P(o){let e,n;return{run(){e==null&&(n=new URL(location.href),e=o.setInterval(()=>{let t=new URL(location.href);t.href!==n.href&&(window.dispatchEvent(new I(t,n)),n=t)},1e3))}}}const b=class b{constructor(e,n){x(this,"isTopFrame",window.self===window.top);x(this,"abortController");x(this,"locationWatcher",P(this));x(this,"receivedMessageIds",new Set);this.contentScriptName=e,this.options=n,this.abortController=new AbortController,this.isTopFrame?(this.listenForNewerScripts({ignoreFirstEvent:!0}),this.stopOldScripts()):this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(e){return this.abortController.abort(e)}get isInvalid(){return E.runtime.id==null&&this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(e){return this.signal.addEventListener("abort",e),()=>this.signal.removeEventListener("abort",e)}block(){return new Promise(()=>{})}setInterval(e,n){const t=setInterval(()=>{this.isValid&&e()},n);return this.onInvalidated(()=>clearInterval(t)),t}setTimeout(e,n){const t=setTimeout(()=>{this.isValid&&e()},n);return this.onInvalidated(()=>clearTimeout(t)),t}requestAnimationFrame(e){const n=requestAnimationFrame((...t)=>{this.isValid&&e(...t)});return this.onInvalidated(()=>cancelAnimationFrame(n)),n}requestIdleCallback(e,n){const t=requestIdleCallback((...c)=>{this.signal.aborted||e(...c)},n);return this.onInvalidated(()=>cancelIdleCallback(t)),t}addEventListener(e,n,t,c){var r;n==="wxt:locationchange"&&this.isValid&&this.locationWatcher.run(),(r=e.addEventListener)==null||r.call(e,n.startsWith("wxt:")?H(n):n,t,{...c,signal:this.signal})}notifyInvalidated(){this.abort("Content script context invalidated"),V.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){window.postMessage({type:b.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:Math.random().toString(36).slice(2)},"*")}verifyScriptStartedEvent(e){var r,s,l;const n=((r=e.data)==null?void 0:r.type)===b.SCRIPT_STARTED_MESSAGE_TYPE,t=((s=e.data)==null?void 0:s.contentScriptName)===this.contentScriptName,c=!this.receivedMessageIds.has((l=e.data)==null?void 0:l.messageId);return n&&t&&c}listenForNewerScripts(e){let n=!0;const t=c=>{if(this.verifyScriptStartedEvent(c)){this.receivedMessageIds.add(c.data.messageId);const r=n;if(n=!1,r&&(e!=null&&e.ignoreFirstEvent))return;this.notifyInvalidated()}};addEventListener("message",t),this.onInvalidated(()=>removeEventListener("message",t))}};x(b,"SCRIPT_STARTED_MESSAGE_TYPE",H("wxt:content-script-started"));let F=b;function Y(){}function S(o,...e){}const U={debug:(...o)=>S(console.debug,...o),log:(...o)=>S(console.log,...o),warn:(...o)=>S(console.warn,...o),error:(...o)=>S(console.error,...o)};return(async()=>{try{const{main:o,...e}=w,n=new F("content",e);return await o(n)}catch(o){throw U.error('The content script "content" crashed on startup!',o),o}})()})();
content;