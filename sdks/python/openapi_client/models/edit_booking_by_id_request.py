...
class EditBookingByIdRequest(BaseModel):
    """
    EditBookingByIdRequest
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Booking event title")
    start: Optional[datetime] = Field(default=None, description="Start time of the Event")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of the meeting")
    __properties: ClassVar[List[str]] = ["title", "start", "end", "status", "description"]
