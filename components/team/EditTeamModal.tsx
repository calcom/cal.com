...
export default function EditTeamModal(props) {
  ...
  const customDomainRef = useRef<HTMLInputElement>();
          ...
          <form>
                ...
                <div>
                  <div className="mb-2">
                    ...
                    <p className="text-sm text-gray-400">
                      Set up a custom domain for your team instead of{" "}
                      <span>
                        <a href={`https://${props.team.id}.calendso.com`} className="text-sm text-blue-500">
                          https://{props.team.id}.calendso.com
                        </a>
                      </span>
                      .
                    </p>
                    <p className="text-sm text-gray-400">
                      Ask your admin to setup a CNAME to {props.team.id}.calendso.com
                    </p>
                  </div>
                  <input
                    ref={customDomainRef}
                    ...
                    defaultValue={props.team?.customDomain}
              ...
              <div className="mb-4 border border-red-400 rounded p-2 px-4">
                ...
                <label className="mt-1">
                  <input
                    ...
                    className="shadow-sm mr-2 focus:ring-black focus:border-black  sm:text-sm border-gray-300 rounded-md"
                  />
                  Disband this team
                </label>
              </div>
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              ...
              <button
                onClick={() => {
                  props.onSave({
                    customDomain: customDomainRef?.current?.value,
                    id: props.team.id,
                  });
                }}
                type="button"
