...
const TimeOptions = (props) => {
  ...
  return (
    selectedTimeZone !== "" && (
      <div className="absolute z-10 w-full max-w-80 rounded-sm border border-gray-200   bg-white px-4 py-2">
        <div className="flex mb-4">
          <div className="w-1/2  text-gray-600 font-medium">Time Options</div>
          <div className="w-1/2">
