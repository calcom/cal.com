            ...
            return (
              <div key={slot.time.format()}>
                <Link href={bookingUrl}>
                  <a
                    className="block py-4 mb-2 font-medium bg-white border rounded-sm dark:bg-gray-600 text-primary-500 dark:text-neutral-200 border-brand dark:border-transparent hover:text-white hover:bg-brand hover:text-brandtext dark:hover:border-black dark:hover:bg-black"
                    data-testid="time">
