...
const AvailableTimesNoReroute: FC<AvailableTimesProps> = ({
  date,
  eventLength,
  eventTypeId,
      ...
      <div className="flex-grow md:h-[364px] overflow-y-auto">
        {!loading &&
          ...
          slots.map((slot) => {
            ...
            if (slot.time.format(timeFormat) === selectedTime) {
            ...
            return (
              <div
                ...
                onClick={() => {
                  onSelect(slot.time.format());
                  setSelectedTime(slot.time.format(timeFormat));
                }}>
...
export default AvailableTimesNoReroute;
