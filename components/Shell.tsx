  ...
  return (
    <Dropdown>
            ...
            <span className="flex items-center flex-grow truncate">
              <span className="flex-grow text-sm truncate">
                ...
                <span className="block font-normal truncate text-neutral-500">
                  {user?.username ? `https://www.theskills.com/${user.username}` : "No public page"}
                </span>
              </span>
              <SelectorIcon
      ...
      <DropdownMenuContent>
        <DropdownMenuItem>
          <a
            onClick={() => signOut({ callbackUrl: `${process.env.THETIS_SITE_HOST}/sign-in` })}
