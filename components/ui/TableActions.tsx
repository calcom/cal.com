        ...
        {({ open }) => (
          <>
            ...
            <Transition
              ...
              <Menu.Items
                static
                className="absolute right-0 w-56 mt-2 origin-top-right bg-white divide-y rounded-sm shadow-lg divide-neutral-100 ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  {actions.map((action) => {
                      ...
                      <Menu.Item key={action.id} disabled={action.disabled}>
                        {({ active }) => (
                          <Element
                            ...
                            <action.icon
                              className="w-5 h-5 text-neutral-400 group-hover:text-neutral-500 ltr:mr-3"
                              aria-hidden="true"
                            />
                            {action.label}
                          </Element>
