      ...
      className: classNames(
        ...
        color === "primary" &&
          (disabled
            ...
            : "border border-transparent dark:text-black text-brandtext bg-brand dark:bg-white hover:bg-opacity-90 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900"),
        color === "secondary" &&
          (disabled
