      ...
      className: classNames(
        ...
        color === "secondary" &&
          (disabled
            ...
            : "border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900    :bg-gray-900"),
        color === "minimal" &&
          (disabled
