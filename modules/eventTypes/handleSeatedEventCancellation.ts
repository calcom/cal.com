...
import { getBookingToDelete } from "../booking/getBookingToDelete"
import { schemaBookingCancelParams } from "@calcom/prisma/zod-utils";
import { getCalendar } from "@calcom/app-store/_utils/getCalendar";
import sendPayload from "@calcom/features/webhooks/lib/sendPayload";
import { HttpError } from "@calcom/lib/http-error";
import { getTranslation } from "@calcom/lib/server";
import { WebhookTriggerEvents, WorkflowMethods } from "@calcom/prisma/client";
import { credentialForCalendarServiceSelect } from "@calcom/prisma/selects/credential";
import { deleteScheduledEmailReminder } from "ee/workflows/lib/reminders/emailReminderManager";
import { deleteScheduledSMSReminder } from "ee/workflows/lib/reminders/smsReminderManager";
import { deleteScheduledWhatsappReminder } from "ee/workflows/lib/reminders/whatsappReminderManager";
...
export async function handleSeatedEventCancellation(
  req: CustomRequest,
  dataForWebhooks: {
    webhooks: {
      id: string;
