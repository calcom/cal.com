const getHtml = ({
  ...
  return `
    <!-- Chatbox Container -->
    <div id="chatbox-container" class="fixed inset-0 md:inset-auto md:bottom-6 md:right-6 z-[999999999999] transform-gpu will-change-transform" style="visibility: hidden; opacity: 0; transform: translateY(8px); transition: all 300ms;">
