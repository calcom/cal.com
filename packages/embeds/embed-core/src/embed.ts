...
// Using import.meta.env instead of process.env because this is a browser bundle built with Vite.
// process.env would require importing from "node:process" which breaks in browsers.
const WEBAPP_URL =
