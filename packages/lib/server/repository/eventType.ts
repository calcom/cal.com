...
export class EventTypeRepository {
  ...
  static async checkCacheEligibility(params: {
    ...
    try {
      ...
      const { getShouldServeCache } = await import("@calcom/features/calendar-cache/lib/getShouldServeCache");
      const { GOOGLE_CALENDAR_TYPE } = await import("@calcom/platform-constants");
      ...
      log.error("Error checking ISR caching eligibility:", error);
      return false;
    }
  }
}
