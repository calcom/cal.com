...
import type * as organization from "@calcom/lib/server/repository/organizationRepository";

vi.mock("@calcom/lib/server/repository/organizationRepository", () => organizationMock);
