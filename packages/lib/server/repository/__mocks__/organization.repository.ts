...
import type * as organization from "@calcom/lib/server/repository/organization.repository";

vi.mock("@calcom/lib/server/repository/organization.repository", () => organizationMock);
