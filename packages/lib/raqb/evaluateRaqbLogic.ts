...
import { Utils as QbUtils, type OldJsonTree } from "@react-awesome-query-builder/core";
...
export const evaluateRaqbLogic = (
  ...
  const state = {
    tree: QbUtils.checkTree(QbUtils.loadTree(queryValue, true, false), queryBuilderConfig),
