    ...
    objects.forEach((object) => {
      ...
      vevents.forEach((vevent) => {
        try {
          ...
          if (String(vevent?.getFirstPropertyValue("transp") ?? "").toUpperCase() === "TRANSPARENT") return;
          ...
          this.log.warn("Skipping malformed calendar event while fetching availability", {
            error,
