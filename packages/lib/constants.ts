...
export const ROADMAP = "https://beenthere.com/roadmap";
export const DESKTOP_APP_LINK = "https://beenthere.com/download";
export const JOIN_DISCORD = "https://go.beenthere.com/discord";
export const POWERED_BY_URL = `${WEBSITE_URL}/?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://beenthere.com/docs";
export const DEVELOPER_DOCS = "https://developer.beenthere.com";
