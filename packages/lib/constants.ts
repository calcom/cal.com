...
export const CREDENTIAL_SYNC_SECRET =
  process.env.CALCOM_WEBHOOK_SECRET || process.env.CALCOM_CREDENTIAL_SYNC_SECRET;
export const CREDENTIAL_SYNC_SECRET_HEADER_NAME =
  process.env.CALCOM_CREDENTIAL_SYNC_SECRET_HEADER_NAME || process.env.CALCOM_WEBHOOK_HEADER_NAME;
