...
import { DeepEnrichmentService } from "@calcom/features/bookings/lib/utils/phases/deepEnrichment";
...
bookingCreateModule.bind(DI_TOKENS.DEEP_ENRICHMENT_SERVICE).toClass(DeepEnrichmentService, {
...
bookingCreateModule.bind(DI_TOKENS.BOOKING_CREATE_SERVICE).toClass(BookingCreateService, {
  ...
  deepEnrichmentService: DI_TOKENS.DEEP_ENRICHMENT_SERVICE,
});
