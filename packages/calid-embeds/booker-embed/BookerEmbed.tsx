import { BookerPlatformWrapper } from "@calcom/atoms";
import {
  BookerPlatformWrapperAtomPropsForIndividual,
  BookerPlatformWrapperAtomPropsForTeam,
} from "@calcom/atoms";
import { CalProvider } from "@calcom/atoms";
import { useGetRoutingFormUrlProps } from "@calcom/atoms";
        ...
        <BookerPlatformWrapper
          ...
          onDryRunSuccess={() => {
            if (onDryRunSuccess) {
              ...
              window.location.href = `https://cal.id/booking/dry-run-successful`;
            }
          }}
          {...rest}
        />
