...
export const SetupTabSkeleton = () => (
  <div className="space-y-6">
    ...
    <SkeletonContainer className="bg-primary border-default rounded-lg border p-6">
...
export const BookingPageTabSkeleton = () => (
  <div className="space-y-6">
    <SkeletonContainer className="bg-primary border-default rounded-lg border p-6">
      <div className="space-y-4">
        <SkeletonText className="h-6 w-40" />
    ...
    <SkeletonContainer className="bg-primary border-default rounded-lg border p-6">
      <div className="space-y-3">
        <SkeletonText className="h-5 w-52" />
        <SkeletonText className="h-10 w-full" />
        <SkeletonText className="h-10 w-full" />
        <SkeletonText className="h-10 w-full" />
      </div>
...
export const DefaultTabSkeleton = () => (
  <div className="space-y-6">
    {Array.from({ length: 3 }).map((_, index) => (
      <SkeletonContainer key={index} className="bg-primary border-default rounded-lg border p-6">
        <div className="space-y-4">
          <SkeletonText className="h-6 w-48" />
          <div className="space-y-2">
            <SkeletonText className="h-10 w-full" />
