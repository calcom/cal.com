...
export function canDisableOrganizerNotifications(workflowSequence: Workflow[]) {
...
export function canDisableParticipantNotifications(workflowSequence: Workflow[]) {
