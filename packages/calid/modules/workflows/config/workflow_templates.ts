...
export const templates: WorkflowTemplate[] = [
  {
    name: "Email reminder for hosts",
    description: "Automated email alerts to ensure hosts never miss events",
    actionType: WorkflowActions.EMAIL_HOST,
    template: WorkflowTemplates.REMINDER,
    triggerEvent: WorkflowTriggerEvents.BEFORE_EVENT,
    time: 30,
  ...
  {
    name: "Thank you email to attendees",
    description: "Send a short appreciation email to solidify connections",
    actionType: WorkflowActions.EMAIL_ATTENDEE,
    template: WorkflowTemplates.THANKYOU,
    triggerEvent: WorkflowTriggerEvents.AFTER_EVENT,
    time: 1,
  ...
  {
    name: "Text reminder for invitees",
    description: "Send automated SMS reminders to help     invitees stay on track",
    actionType: WorkflowActions.SMS_ATTENDEE,
    template: WorkflowTemplates.REMINDER,
    triggerEvent: WorkflowTriggerEvents.BEFORE_EVENT,
    time: 30,
