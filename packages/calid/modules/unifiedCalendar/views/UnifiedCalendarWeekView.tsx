  ...
  return (
    <div>
      <div className="bg-default sticky top-0 z-20">
        <div className="border-border/30 bg-default flex border-b">
        ...
        <div className="border-border/20 bg-default flex border-b">
            ...
            {viewDays.map((day) => {
              ...
              return (
                <div
                  ...
                  className="border-border/20 bg-background min-h-12 flex-1 border-l p-1.5">
