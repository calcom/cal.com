...
import { Badge, Button, Label, PhoneInput, Input } from "@calid/features/ui";
...
// Utility function to check if phone number meets requirements
export function isPhoneNumberComplete(
  ...
  return true; // Just valid format is enough when verification is not required
}
