...
//           restrictPosition={!aspect} // Allow free positioning when no aspect ratio
//         />
//       </div>
//       <Slider
//         value={zoom}
...
//   // Use provided dimensions or calculate from crop area
...
function CropContainer({
  ...
  useEffect(() => {
    const loadImageDimensions = async () => {
      ...
      // Calculate container dimensions to fit the image
      const maxWidth = 640; // 40rem = 640px
