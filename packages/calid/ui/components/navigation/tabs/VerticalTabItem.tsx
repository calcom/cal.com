        ...
        <>
          <Link
            ...
            className={classNames(
              ...
              "hover:bg-emphasis [&[aria-current='page']]:bg-active dark:[&[aria-current='page']]:bg-emphasis group-hover:text-default group flex w-full flex-row items-center rounded-md transition [&[aria-current='page']]:text-white",
