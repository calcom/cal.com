-- AlterTable
ALTER TABLE "Host" ADD COLUMN     "hostGroupId" INTEGER;
...
-- AddForeignKey
ALTER TABLE "Host" ADD CONSTRAINT "Host_hostGroupId_fkey" FOREIGN KEY ("hostGroupId") REFERENCES "HostGroup"("id") ON DELETE SET NULL ON UPDATE CASCADE;
