...
import {
  ...
  revalidateOgImageMeetingTag,
} from "@calcom/web/app/(use-page-wrapper)/event-types/[type]/actions";
...
const EventTypeWeb = ({
  ...
  const updateMutation = trpc.viewer.eventTypes.update.useMutation({
    onSuccess: async () => {
      ...
      // Invalidate OG image cache for this event type
      await revalidateOgImageMeetingTag(eventType.id);
