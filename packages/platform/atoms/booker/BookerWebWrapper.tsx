...
export const BookerWebWrapper = (props: BookerWebWrapperAtomProps) => {
  ...
  return (
    <BookerComponent
      ...
      onClickOverlayContinue={(provider: "calcom" | "google-for-overlay" = "calcom") => {
        const currentUrl = new URL(window.location.href);
        currentUrl.searchParams.set("overlayCalendar", "true");
        if (provider === "google-for-overlay") {
          signIn("google-for-overlay", { callbackUrl: currentUrl.toString() });
        } else {
