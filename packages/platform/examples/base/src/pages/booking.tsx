...
import { Booker, useEventTypes, useTeamEventTypes, useMe } from "@calcom/atoms";
...
export default function Bookings(props: { calUsername: string; calEmail: string }) {
  ...
  const { data: me } = useMe();
  const { isLoading: isLoadingTeamEvents, data: teamEventTypes } = useTeamEventTypes(
    me?.data?.teams?.[1]?.teamId || 0
  );
