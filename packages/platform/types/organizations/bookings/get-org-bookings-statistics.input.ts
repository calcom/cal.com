...
export class GetOrganizationsBookingsStatisticsInput extends GetBookingsInput_2024_08_13 {
  @IsArray()
  @IsOptional()
  @Transform(({ value }) => {
  ...
  @ApiProperty({
    type: String,
    required: false,
    description: "Filter bookings statistics by ids of users within your organization.",
