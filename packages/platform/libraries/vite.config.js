...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        schedules: resolve(__dirname, "./src/schedules.ts"),
        emails: resolve(__dirname, "./src/emails.ts"),
        "event-types": resolve(__dirname, "./src/event-types.ts"),
        "app-store": resolve(__dirname, "./src/app-store.ts"),
        workflows: resolve(__dirname, "./src/workflows.ts"),
        slots: resolve(__dirname, "./src/slots.ts"),
        conferencing: resolve(__dirname, "./src/conferencing.ts"),
        repositories: resolve(__dirname, "./src/repositories.ts"),
        bookings: resolve(__dirname, "./src/bookings.ts"),
        organizations: resolve(__dirname, "./src/organizations.ts"),
  ...
  resolve: {
    ...
    alias: {
      "@calcom/lib/server/i18n": path.resolve(__dirname, "./src/i18n.ts"),
      "./server/i18n": path.resolve(__dirname, "./src/i18n.ts"),
      "../server/i18n": path.resolve(__dirname, "./src/i18n.ts"),
