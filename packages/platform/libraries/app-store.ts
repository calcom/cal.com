...
export { BuildCalendarService as IcsFeedCalendarService } from "@calcom/app-store/ics-feedcalendar/lib";
...
export { BuildCalendarService as CalendarService } from "@calcom/app-store/applecalendar/lib";
