...
export { createHandler as createEventType } from "@calcom/trpc/server/routers/viewer/quarantine/eventTypes/create.handler";
export { updateHandler as updateEventType } from "@calcom/trpc/server/routers/viewer/quarantine/eventTypes/update.handler";

export type { TUpdateInputSchema as TUpdateEventTypeInputSchema } from "@calcom/trpc/server/routers/viewer/quarantine/eventTypes/update.schema";
...
export type { UpdateEventTypeReturn } from "@calcom/trpc/server/routers/viewer/quarantine/eventTypes/update.handler";
