...
function generateFiles() {
  ...
  videoOutput.push("");
  videoOutput.push("export {");
  videoOutput.push("  FAKE_DAILY_CREDENTIAL,");
  videoOutput.push("  generateGuestMeetingTokenFromOwnerMeetingToken,");
  videoOutput.push("  setEnableRecordingUIAndUserIdForOrganizer,");
  videoOutput.push("  updateMeetingTokenIfExpired");
  videoOutput.push('} from "./dailyvideo/lib/VideoApiAdapter";');
