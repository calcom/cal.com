...
import { handleBannerUpdate } from "./update.handler";
...
describe("handleBannerUpdate", () => {
  ...
  it("should return undefined when banner is undefined (not provided)", async () => {
    const result = await handleBannerUpdate(undefined, mockTeamId);
  ...
  it("should return null when banner is explicitly set to null", async () => {
    const result = await handleBannerUpdate(null, mockTeamId);
  ...
  it("should upload and return URL for valid PNG base64 banner", async () => {
    ...
    const result = await handleBannerUpdate(validBase64, mockTeamId);
  ...
  it("should return undefined for invalid banner string", async () => {
    const result = await handleBannerUpdate("invalid-banner-string", mockTeamId);
  ...
  it("should return undefined for empty banner string", async () => {
    const result = await handleBannerUpdate("", mockTeamId);
  ...
  it("should return undefined for non-image base64 string", async () => {
    ...
    const result = await handleBannerUpdate(invalidBase64, mockTeamId);
