import type { EventType, WebhookTriggerEvents } from "@prisma/client";
...
import { sendRequestRescheduleEmail } from "@calcom/emails/email-manager";
...
import type { PersonAttendeeCommonFields } from ".";
import type { TRPCEndpointOptions } from "../../../trpc";
import type { requestRescheduleSchema } from "./schemas/requestRescheduleSchema";

export const requestReschedule = async ({
  ctx,
  input,
}: TRPCEndpointOptions<typeof requestRescheduleSchema>) => {
