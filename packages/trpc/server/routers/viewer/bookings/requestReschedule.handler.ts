  ...
  const payload = {
    ...
    ...(bookingToReschedule.tracking && {
      tracking: {
        ...
        utm_medium: bookingToReschedule.tracking.utm_medium,
        utm_campaign: bookingToReschedule.tracking.utm_campaign,
        utm_term: bookingToReschedule.tracking.utm_term,
