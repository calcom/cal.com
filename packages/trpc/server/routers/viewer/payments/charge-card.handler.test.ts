...
describe("chargeCardHandler", () => {
  ...
  describe("authorization", () => {
    it("throws FORBIDDEN when user does not have access to booking", async () => {
  ...
  describe("booking validation", () => {
    ...
    it("throws BAD_REQUEST when booking has no payment", async () => {
      mockBookingRepository.getBookingForPaymentProcessing.mockResolvedValue({
        id: 123,
        payment: [],
      });
      ...
      await expect(
        ...
        code: "BAD_REQUEST",
        message: "No payment found for booking 123",
      });
