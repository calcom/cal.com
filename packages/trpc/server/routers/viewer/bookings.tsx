...
export const bookingsRouter = router({
  ...
  requestReschedule: authedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (bookingToReschedule) {
        ...
        const { deleteMeeting } = await import("@calcom/core/videoClient");
        ...
        const { sendRequestRescheduleEmail } = await import("@calcom/emails");
        // Send emails
  ...
  confirm: bookingsProcedure.input(bookingConfirmPatchBodySchema).mutation(async ({ ctx, input }) => {
    ...
    if (confirmed) {
      ...
      const { sendDeclinedEmails } = await import("@calcom/emails");
