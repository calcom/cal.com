...
async function getEventType(ctx: { prisma: typeof prisma }, input: GetScheduleInput) {
...
async function getDynamicEventType(ctx: { prisma: typeof prisma }, input: GetScheduleInput) {
...
function getRegularOrDynamicEventType(ctx: { prisma: typeof prisma }, input: GetScheduleInput) {
...
export async function getSchedule(input: GetScheduleInput, ctx: { prisma: typeof prisma }) {
  if (input.debug === true) {
