...
import type { BookingRepository } from "@calcom/lib/server/repository/bookingRepository";
import type { EventTypeRepository } from "@calcom/lib/server/repository/eventTypeRepository";
import type { RoutingFormResponseRepository } from "@calcom/lib/server/repository/formResponseRepository";
import type { PrismaOOORepository } from "@calcom/lib/server/repository/oooRepository";
import type { ScheduleRepository } from "@calcom/lib/server/repository/scheduleRepository";
import type { SelectedSlotsRepository } from "@calcom/lib/server/repository/selectedSlotsRepository";
import type { TeamRepository } from "@calcom/lib/server/repository/teamRepository";
import type { UserRepository } from "@calcom/lib/server/repository/userRepository";
