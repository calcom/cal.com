...
import type { BookingRepository } from "@calcom/lib/server/repository/booking.repository";
import type { EventTypeRepository } from "@calcom/lib/server/repository/eventType.repository";
import type { RoutingFormResponseRepository } from "@calcom/lib/server/repository/formResponse.repository";
import type { PrismaOOORepository } from "@calcom/lib/server/repository/ooo.repository";
import type { ScheduleRepository } from "@calcom/lib/server/repository/schedule.repository";
import type { SelectedSlotsRepository } from "@calcom/lib/server/repository/selectedSlots.repository";
import type { TeamRepository } from "@calcom/lib/server/repository/team.repository";
import type { UserRepository } from "@calcom/lib/server/repository/user.repository";
