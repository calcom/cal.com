...
import type { SerializableField, OrderedResponses } from "@calcom/features/routing-forms/types/types";
import type { FormResponse, SerializableForm } from "@calcom/features/routing-forms/types/types";
  ...
  try {
    if (typeof window === "undefined") {
      const { default: ResponseEmail } = await import(
        "@calcom/features/routing-forms/emails/templates/response-email"
      );
