            ...
            <div className="ml-2 mr-2 md:ml-5">
              ...
              {!newApiKey ? (
                ...
                <>
                  ...
                  <div className="my-2 mt-3 h-[40px] flex-wrap sm:flex sm:flex-nowrap">
                    <pre className="block h-full w-full whitespace-pre-wrap rounded-md rounded-r-none bg-gray-100 py-2 pl-2 pr-5">
                      {newApiKey}
                    </pre>
                    <Tooltip side="top" content={t("copy_to_clipboard")}>
                      <Button
                        ...
                        type="button"
                        className="mt-2 h-full text-base sm:mt-0 sm:rounded-l-none">
