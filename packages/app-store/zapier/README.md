...
4. Create Integration
   - Name: Cal ID
   - Description: [Cal ID](https://cal.id) is a scheduling infrastructure for absolutely everyone.
...
4. Test your authentication —> First you have to install Zapier in the [Cal ID](https://cal.id)App Store and generate an API key, use this API key to test your authentication (only zapier Api key works)
