...
const log = logger.getSubLogger({ prefix: ["[app-store] video-adapter-factory"] });

/**
 * Factory function to create video adapters from credentials
 * This is the core App Store functionality for video conferencing apps
 */
