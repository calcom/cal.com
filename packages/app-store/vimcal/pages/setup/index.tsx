...
export default function VimcalSetup() {
  const { t } = useLocale();
    ...
    <div className="flex h-screen bg-gray-200">
      <div className="m-auto rounded bg-white p-5 md:w-[520px] md:p-10">
        <div className="flex flex-col space-y-5 md:flex-row md:space-y-0 md:space-x-5">
          <div>
            <img src="/api/app-store/vimcal/logo.png" alt="vimcal" className="h-12 w-12 max-w-2xl" />
          </div>
          <div>
            ...
            <div className="mt-1 text-sm">
              ...
              <a
                ...
                href="https://app.vimcal.com/settings/api_keys"
                target="_blank"
            ...
            <div className="my-2 mt-3">
              <Form
                ...
                handleSubmit={async (values) => {
                  const res = await fetch("/api/integrations/vimcal/add", {
                    method: "POST",
                ...
                <div className="mt-5 justify-end space-x-2 sm:mt-4 sm:flex">
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      setTestLoading(true);
                      const res = await fetch("/api/integrations/vimcal/check", {
                        method: "POST",
