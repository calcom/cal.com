...
- Add [Cal ID](https://cal.id) booking calendar to any WordPress page/post with a simple shortcode.
- Display your [Cal ID](https://cal.id) booking calendar inline or in a popup.
