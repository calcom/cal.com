...
export default function HEYSetup() {
  const { t } = useLocale();
      ...
      <div className="bg-default m-auto rounded p-5 md:w-[560px] md:p-10">
        <div className="flex flex-col space-y-5 md:flex-row md:space-x-5 md:space-y-0">
          <div>
            ...
            <img src="/api/app-store/hey/icon.svg" alt="Hey HEYICS" className="h-12 w-12 max-w-2xl" />
          </div>
            ...
            <div className="my-2 mt-3">
              <Form
                ...
                handleSubmit={async (_) => {
                  setErrorMessage("");
                  const res = await fetch("/api/integrations/hey/add", {
                    method: "POST",
