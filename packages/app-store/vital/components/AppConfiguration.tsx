      ...
      <div className="w-full">
        ...
        <div className="mx-2 mt-0 inline-flex w-24 items-baseline">
          <input
            ...
            className="pr-12shadow-sm mt-1 block w-full rounded-sm border border-gray-300 py-2 pl-6 focus:border-neutral-500 focus:ring-neutral-500 focus-visible:outline-none sm:text-sm"
          />
          <p className="ml-2">
