      ...
      <div className="route-config">
        {routes.map((route, key) => {
          ...
          return (
            <div
              key={key}
              className="-mx-4 mb-4 flex w-4/6 flex-col rounded-sm border border-neutral-200 bg-white sm:mx-0 sm:px-8">
              <div className="cal-query-builder m-4 my-8 mr-10 ">
                <div>
                  <div className="flex items-center text-sm text-gray-900">
                    <div className="flex">
                      <Label>Route {key + 1}</Label>
