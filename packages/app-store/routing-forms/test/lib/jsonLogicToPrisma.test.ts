  ...
  describe("Text Operand", () => {
    ...
    describe("Number Type", () => {
      it("should support 'greater than' operator", () => {
        ...
        expect(prismaWhere).toEqual({
          AND: [
              { response: { path: ["a0d113a8-8e40-49b7-87b1-7f4ab57d226f", "value"], gt: 100 } },
            ],
        });
      ...
      it("should support 'greater than or equal to' operator", () => {
        ...
        expect(prismaWhere).toEqual({
          AND: [
              { response: { path: ["a0d113a8-8e40-49b7-87b1-7f4ab57d226f", "value"], gte: 100 } },
            ],
        });
      ...
      it("should support 'less than' operator", () => {
        ...
        expect(prismaWhere).toEqual({
          AND: [
              { response: { path: ["a0d113a8-8e40-49b7-87b1-7f4ab57d226f", "value"], lt: 100 } },
            ],
        });
      ...
      it("should support 'less than or equal to' operator", () => {
        ...
        expect(prismaWhere).toEqual({
          AND: [
              { response: { path: ["a0d113a8-8e40-49b7-87b1-7f4ab57d226f", "value"], lte: 100 } },
            ],
        });
      });
    })
