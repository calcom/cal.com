...
import { useEmbedDialogCtx, EmbedDialogProvider } from "@calcom/features/embed/lib/hooks/useEmbedDialogCtx";
...
import type {
  ...
  PreviewState,
  EmbedConfig,
} from "@calcom/features/embed/lib/types";
  ...
  const parsedTabs = tabs.map((t) => {
    ...
    return {
      ...
      ...(noQueryParamMode
        ? {
            onClick: () => {
              gotoState({ embedType: embedType, embedTabName: tabName });
            },
              ...
              <Collapsible
                ...
                <CollapsibleContent>
                  <div className="text-sm">
                    ...
                    {!eventTypeHideOptionDisabled && embedParams.embedTabName !== EmbedTabName.ATOM_REACT ? (
                ...
                <>
                  <div className="flex h-full flex-col">
                    {tabs.map((tab) => {
                      if (embedType !== "email") {
                        ...
                        return (
                          <div
                            ...
                            <div
                              className={
                                embedParams.embedTabName === "embed-preview" ? "mt-2 block" : "hidden"
                              }
                            />
                          </div>
                        );
                      ...
                      if (embedType === "email" && (tab.name !== "Preview" || !eventTypeData?.eventType))
                        return;
  ...
  return (
    <div className="flex h-full w-full flex-col">
      <ChooseEmbedTypesDialogContent
        types={types}
        currentType={currentEmbedType.embedType}
      ...
      <SingleForm
        ...
        Page={({ hookForm, form, uptoDateForm }) => (
          <EmbedDialog
            ...
            defaultBrandColor={
              user ? { brandColor: user.brandColor, darkBrandColor: user.darkBrandColor } : null
            }
            noQueryParamMode={true}
          />
        )}
