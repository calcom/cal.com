      ...
      <div className="bg-default m-auto max-w-[43em] overflow-auto rounded pb-10 md:p-10">
        <div className="md:flex md:flex-row">
          ...
          <div className="ml-2 ltr:mr-2 rtl:ml-2 md:ml-5">
            ...
            <div className="mt-1 text-xl">{t("bigbluebutton_connect_heading")}</div>
            ...
            <Form
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => (
                  <>
                    <Label className="text-emphasis">{t("bigbluebutton_server_url")}</Label>
                    <TextField
                      required
                      type="url"
                      value={value}
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => (
                  <>
                    <Label className="text-emphasis mt-6">{t("bigbluebutton_shared_secret")}</Label>
              ...
              <Controller
                ...
                render={({ field: { value, onChange } }) => (
                  <>
                    <Label className="text-emphasis mt-6">{t("bigbluebutton_checksum_algorithm")}</Label>
            ...
            <div>
              ...
              <ol className="text-default mt-3 list-inside list-decimal space-y-2 text-sm">
                <li>
                  <span>{t("bigbluebutton_step1")}</span>
                  <div className="my-2">
                ...
                <li>
                  <span>{t("bigbluebutton_step2")}</span>
                  <div className="my-2">
                ...
                <li>
                  <span>{t("bigbluebutton_step3")}</span>
                </li>
              </ol>
            </div>
          </div>
