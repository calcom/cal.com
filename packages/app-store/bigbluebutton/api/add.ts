...
/**
 * Installs the BigBlueButton app for the current user (or team).
 * BigBlueButton uses a shared secret rather than OAuth, so the
 * actual credentials live in the admin-managed app keys.
 */
