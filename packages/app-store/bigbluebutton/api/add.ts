...
import { createDefaultInstallation, checkInstalled } from "@calcom/app-store/_utils/installation";
...
async function postHandler(req: NextApiRequest) {
  ...
  if (!valid) {
    throw new HttpError({
      statusCode: 400,
      message: "Invalid BigBlueButton options — check your server URL, shared secret, and checksum algorithm",
    });
  }
