...
async function postHandler(req: NextApiRequest) {
  ...
  const teamId = teamIdParam && !Number.isNaN(Number(teamIdParam)) ? Number(teamIdParam) : undefined;
  ...
  return { url: getInstalledAppPath({ variant: appConfig.variant, slug: appConfig.slug }) };
}
