export declare const appKeysSchemas: {
    ...
    btcpayserver: import("zod").ZodObject<{}, "strip", import("zod").ZodTypeAny, {}, {}>;
    ...
    databuddy: import("zod").ZodObject<{}, "strip", import("zod").ZodTypeAny, {}, {}>;
    dub: import("zod").ZodObject<{
        redirect_uris: import("zod").ZodString;
        client_id: import("zod").ZodString;
        client_secret: import("zod").ZodString;
    }, "strip", import("zod").ZodTypeAny, {
        client_id: string;
    ...
    hitpay: import("zod").ZodObject<{}, "strip", import("zod").ZodTypeAny, {}, {}>;
    ...
    insihts: import("zod").ZodObject<{}, "strip", import("zod").ZodTypeAny, {}, {}>;
    ...
    nextcloudtalk: import("zod").ZodObject<{
        nextcloudTalkHost: import("zod").ZodString;
        nextcloudTalkPattern: import("zod").ZodOptional<import("zod").ZodString>;
        nextcloudTalkClientId: import("zod").ZodString;
        nextcloudTalkClientSecret: import("zod").ZodString;
    }, "strip", import("zod").ZodTypeAny, {
        nextcloudTalkHost: string;
        nextcloudTalkClientId: string;
        nextcloudTalkClientSecret: string;
        nextcloudTalkPattern?: string | undefined;
    }, {
        nextcloudTalkHost: string;
        nextcloudTalkClientId: string;
        nextcloudTalkClientSecret: string;
