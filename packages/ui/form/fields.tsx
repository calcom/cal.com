  ...
  return (
    <input
      ...
      className={classNames(
        "mt-1 block w-full rounded-sm border border-gray-300 py-2 px-3 shadow-sm focus:border-neutral-800 focus:ring-1 focus:ring-neutral-800 focus-visible:outline-none sm:text-sm",
        props.className
      )}
    />
  );
