...
export const DropdownMenuItem = forwardRef<HTMLDivElement, DropdownMenuItemProps>(
  ({ className = "", ...props }, forwardedRef) => (
    <DropdownMenuPrimitive.Item
      className={`focus:ring-brand-800 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-1 ${className}`}
      {...props}
      ref={forwardedRef}
    />
  )
  ...
  return (
    <ButtonOrLink
      ...
      className={classNames(
        "focus:ring-brand-800 f inline-flex w-full items-center px-3 py-2 text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-1",
