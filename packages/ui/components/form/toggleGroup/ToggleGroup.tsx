    ...
    <>
      <RadixToggleGroup.Root
        ...
        className={classNames(
          "min-h-9 relative inline-flex gap-0.5 rounded-md border border-gray-200 p-1",
          props.className,
          isFullWidth && "w-full"
        )}>
        ...
        <span
          aria-hidden
          className="absolute top-[4px] bottom-[4px] left-0 z-[0] rounded-[4px] bg-gray-200 transition-all"
          ...
          <RadixToggleGroup.Item
            ...
            className={classNames(
              ...
              option.disabled
                ...
                : "[&[aria-checked='false']]:hover:bg-gray-100",
              isFullWidth && "w-full"
            )}
            ref={(node) => {
