      ...
      <div
        ...
        <PrimitiveSwitch.Root
          className={cx(
            ...
            "focus:ring-brand-default focus:border-subtle h-5 w-[34px] min-w-[34px] rounded-full shadow-none transition focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1",
            props.className
          )}
          {...primitiveProps}>
