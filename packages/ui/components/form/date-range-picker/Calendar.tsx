  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "w-11 h-8 text-sm font-medium text-default",
        ...
        day: cn(
          ...
          "h-11 w-11 p-0 text-sm font-medium aria-selected:opacity-100 inline-flex items-center justify-center"
        ),
