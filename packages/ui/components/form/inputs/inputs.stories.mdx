...
import { Icon,Select,UnstyledSelect } from "@calcom/ui";
...
<Examples title="Input Types">
  ...
  <Example title="Suffix With Select">
    <InputField placeholder="Suffix" inputIsFullWidth={false} addOnPadding={0} addOnSuffix={<UnstyledSelect options={[{value:"TEXT",label:"Text"}]}/>}/>
  </Example>
