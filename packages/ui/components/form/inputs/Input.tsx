  ...
  return (
    <input
      ...
      className={classNames(
        "mb-2 block h-9 rounded-md border border-gray-300 py-2 px-3 text-sm placeholder:text-gray-400 hover:border-gray-400 focus:border-neutral-300 focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 focus-visible:outline-none",
        isFullWidth && "w-full",
        props.className
      )}
    />
...
export const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(function TextAreaInput(props, ref) {
  return (
    <textarea
      ...
      {...props}
      className={classNames(
        "block w-full rounded-md border border-gray-300 py-2 px-3 text-sm hover:border-gray-400 focus:border-neutral-300 focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 focus-visible:outline-none",
        props.className
      )}
    />
  );
