...
const ColorPicker = (props: ColorPickerProps) => {
  ...
  return (
    <div className="mt-1 flex items-center justify-center">
      <Popover.Root>
        <div className="border-default flex items-center rounded-l-md border border-r-0 p-1.5">
      ...
      <HexColorInput
        className="border-default bg-default text-default block w-full border px-3 py-2 ltr:rounded-r-md rtl:rounded-l-md sm:text-sm"
        color={color}
        onChange={(val) => {
          setColor(val);
          props.onChange(val);
