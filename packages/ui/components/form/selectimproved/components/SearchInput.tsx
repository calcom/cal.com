      ...
      <input
        ...
        className={
          classNames && classNames.searchBox
            ...
            : "dark:border-darkgray-300 dark:bg-darkgray-100   focus:border-darkgray-900 text-subtle w-full rounded-[6px] border border-subtle py-2 pl-8 text-sm focus:border-gray-900 focus:outline-none focus:ring-0"
        }
        autoFocus
        type="text"
