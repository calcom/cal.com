...
<Examples title="Icons">
  ...
  <Example title="Icon left">
    <Button StartIcon={(props) => <Icon {...props} name="plus" />}>Button text</Button>
  </Example>
  <Example title="Icon right">
    <Button EndIcon={(props) => <Icon {...props} name="plus" />}>Button text</Button>
  </Example>
</Examples>

<Examples title="Icons">
  <Example title="Icon Normal">
    <Button StartIcon={(props) => <Icon {...props} name="x" />} variant="icon" size="base" color="minimal"></Button>
  </Example>
  <Example title="Icon Small">
    <Button StartIcon={(props) => <Icon {...props} name="x" />} variant="icon" size="sm" color="minimal"></Button>
  </Example>
  <Example title="Icon Loading">
    <Button StartIcon={(props) => <Icon {...props} name="x" />} variant="icon" size="sm" color="minimal" loading></Button>
  </Example>
</Examples>
  ...
  <Story name="All variants">
    <VariantsTable titles={["Primary", "Secondary", "Minimal", "Destructive", "Icon"]} columnMinWidth={150}>
      <VariantRow variant="Default">
        ...
        <Button color="destructive" variant="icon" StartIcon={(props) => <Icon {...props} name="x" />}></Button>
      </VariantRow>
      <VariantRow variant="Hover">
        ...
        <Button className="sb-pseudo--hover" color="destructive" variant="icon" StartIcon={(props) => <Icon {...props} name="x" />}></Button>
      </VariantRow>
      <VariantRow variant="Focus">
        ...
        <Button className="sb-pseudo--focus" color="destructive" variant="icon" StartIcon={(props) => <Icon {...props} name="x" />}></Button>
      </VariantRow>
      <VariantRow variant="Loading">
        ...
        <Button loading color="destructive" variant="icon" StartIcon={(props) => <Icon {...props} name="x" />}></Button>
      </VariantRow>
      <VariantRow variant="Disabled">
        ...
        <Button disabled color="minimal" variant="icon" StartIcon={(props) => <Icon {...props} name="x" />}></Button>
      </VariantRow>
    </VariantsTable>
  </Story>
  <Story
