...
import { Examples, Example, Note, Title,FancyTable,VarientColumn} from '@calcom/storybook_v2/components'
...
<Canvas>
  <Story name="All variants">
    <FancyTable >
      <VarientColumn variant="Default">
        <Button>Button text</Button>
      </VarientColumn>
      <VarientColumn variant="Secondary">
        <Button color="secondary">Button text</Button>
      </VarientColumn>
      <VarientColumn variant="Minimal">
        <Button color="minimal">Button text</Button>
      </VarientColumn>
    </FancyTable>
  </Story>
