  ...
  "inline-flex items-center text-sm font-medium relative rounded-md transition-colors",
  {
    ...
    compoundVariants: [
      ...
      ...applyStyleToMultipleVariants({
        ...
        color: "destructive",
        className:
          "border border-gray-300 dark:text-white text-gray-900 hover:text-red-700 focus-visible:text-red-700 dark:hover:text-red-700 dark:focus-visible:text-red-700 focus-visible:border-red-100 hover:bg-red-100  focus-visible:bg-red-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset focus-visible:ring-red-700",
      }),
