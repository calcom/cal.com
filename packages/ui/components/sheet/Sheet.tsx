...
const SheetTrigger = function SheetTrigger({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Trigger>>;
}) {
...
const SheetClose = function SheetClose({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Close>>;
}) {
...
const SheetOverlay = function SheetOverlay({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Overlay>>;
}) {
  return (
...
const SheetContent = function SheetContent({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Content>>;
}) {
  return (
    <SheetPortal>
      <SheetOverlay>
...
const SheetTitle = function SheetTitle({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Title>>;
}) {
  return (
...
const SheetDescription = function SheetDescription({
  ...
  ref?: React.Ref<React.ElementRef<typeof SheetPrimitives.Description>>;
}) {
  return (
