  ...
  return (
    <div
      ...
      className={classNames(
        "alert-banner flex min-h-[40px] w-full items-start justify-between gap-8 bg-gray-50 py-2 px-4 text-center lg:items-center [&+.alert-banner]:border-t [&+.alert-banner]:border-black",
