  ...
  return (
    <div className="editor rounded-md">
      <LexicalComposer initialConfig={{ ...editorConfig }}>
        <div className="editor-container hover:border-emphasis !rounded-lg p-0 transition focus-within:border-none focus-within:ring-brand-default focus-within:ring-2">
          <ToolbarPlugin
