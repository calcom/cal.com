...
import { COMPANY_NAME, IS_CALCOM, IS_SELF_HOSTED } from "@calcom/lib/constants";
...
const CalComVersion = `v.${process.env.NEXT_PUBLIC_CALCOM_VERSION}-${!IS_SELF_HOSTED ? "h" : "sh"}`;
