        ...
        <>
          <Link
            ...
            className={classNames(
              ...
              "hover:bg-subtle [&[aria-current='page']]:bg-active [&[aria-current='page']]:text-default group-hover:text-default group flex w-full flex-row items-center rounded-md p-2 transition",
