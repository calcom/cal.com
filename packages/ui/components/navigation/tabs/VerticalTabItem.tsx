        ...
        <>
          <Link
            ...
            className={classNames(
              ...
              "hover:bg-subtle [&[aria-current='page']]:bg-subtle [&[aria-current='page']]:text-emphasis group-hover:text-default group flex flex-row items-center rounded-md p-2 transition me-5 h-7 w-auto !px-2",
