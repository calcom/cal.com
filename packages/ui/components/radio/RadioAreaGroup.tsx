  ...
  return (
    <div
      ...
      <RadioGroupPrimitive.Item
        ...
        {...props}
        className={classNames(
          "hover:bg-subtle disabled:hover:bg-default border-default focus:ring-brand-default absolute left-3 top-[0.9rem] mt-0.5 h-4 w-4 flex-shrink-0 rounded-full border transition focus:ring-2 disabled:cursor-not-allowed",
        ...
        <RadioGroupPrimitive.Indicator
          className={classNames(
            ...
            props.disabled ? "after:bg-muted" : "bg-brand-default"
          )}
        />
      </RadioGroupPrimitive.Item>
