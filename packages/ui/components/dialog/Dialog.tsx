      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className={classNames(
            ...
            props.size == "xl"
              ? "p-8 pb-4 sm:max-w-[90rem]"
              : props.size == "lg"
              ? "p-8 pb-4 sm:max-w-[70rem]"
              : props.size == "md"
              ? "p-8 pb-4 sm:max-w-[48rem]"
              : "p-8 pb-4 sm:max-w-[35rem]",
            "max-h-[95vh]",
...
export function DialogFooter(props: { children: ReactNode; className?: string; showDivider?: boolean }) {
  return (
    <div className={classNames("bg-default", props.className)}>
      ...
      <div className={classNames("bg-default flex justify-end space-x-2 pt-4 rtl:space-x-reverse")}>
        {props.children}
      </div>
    </div>
  );
