      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className={classNames(
            "fadeIn fixed left-1/2 top-1/2 z-50 w-full min-w-[270px] -translate-x-1/2 -translate-y-1/2 rounded bg-white text-left shadow-xl focus-visible:outline-none sm:align-middle",
            props.size == "xl"
              ? "p-8 sm:max-w-[90rem]"
              : props.size == "lg"
              ? "p-8 sm:max-w-[70rem]"
