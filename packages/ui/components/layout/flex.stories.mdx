...
<Meta title="Layout/Spacing" component={Flex} />
...
<Examples title="Spacing">
  <TooltipPrimitive.Provider>
    ...
    <Example title="1">
      <Tooltip content="1px">
        <div className="h-4 w-1 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="2">
      <Tooltip content="1px">
        <div className="h-4 w-2 bg-gray-900"> </div>
      </Tooltip>

    </Example>
    <Example title="3">
      <Tooltip content="1px">
        <div className="h-4 w-3 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="4">
      <Tooltip content="1px">
        <div className="h-4 w-4 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="5">
      <Tooltip content="1px">
        <div className="h-4 w-5 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="6">
      <Tooltip content="1px">
        <div className="h-4 w-6 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="8">
      <Tooltip content="1px">
        <div className="h-4 w-8 bg-gray-900"> </div>
      </Tooltip>
    </Example>
    <Example title="10">
      <Tooltip content="1px">
