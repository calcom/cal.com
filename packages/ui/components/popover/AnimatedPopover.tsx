  ...
  return (
    <Popover.Root onOpenChange={setOpen} modal={true}>
      <Popover.Trigger asChild>
        <div
          ref={ref}
          className="hover:border-emphasis border-default placeholder:text-muted mb-2 flex h-9 max-h-72 items-center justify-between whitespace-nowrap rounded-md border px-3 py-2 text-sm hover:cursor-pointer focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1">
      ...
      <Popover.Content side="bottom" align={align} asChild>
        <div
          className={classNames(
            "bg-default absolute z-50 mt-2 max-h-64 w-56 overflow-y-scroll rounded-md py-[2px] shadow-sm ring-1 ring-black ring-opacity-5 focus-within:outline-none",
