...
export const ProgressToast = ({
  ...
  <div
    className={classNames(
      "animate-fade-in-up bg-default dark:bg-inverted text-emphasis dark:text-inverted shadow-elevation-low border-subtle mb-2 flex h-auto flex-col space-y-2 rounded-lg border px-3 py-2.5 text-sm font-semibold md:max-w-sm"
    )}>
