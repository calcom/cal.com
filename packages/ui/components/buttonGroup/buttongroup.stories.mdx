...
>
  <Example title="Default" >
    <ButtonGroup>
      <Button StartIcon={FiTrash} size="icon" color="secondary" />
      <Button StartIcon={FiNavigation} size="icon" color="secondary" />
      <Button StartIcon={FiClipboard} size="icon" color="secondary" />
    </ButtonGroup>
  </Example>
  ...
  <Story
    ...
    <VariantsTable titles={["Default",'Secondary',"Minimal"]} columnMinWidth={150}>
      <VariantRow variant="Default">
        <ButtonGroup>
          <Button StartIcon={FiTrash} size="icon"  />
          <Button StartIcon={FiNavigation} size="icon"/>
          <Button StartIcon={FiClipboard} size="icon"  />
        </ButtonGroup>
        <ButtonGroup>
          <Button StartIcon={FiTrash} size="icon" color="secondary" />
          <Button StartIcon={FiNavigation} size="icon" color="secondary" />
        ...
        <ButtonGroup>
          <Button StartIcon={FiTrash} size="icon" color="minimal" />
          <Button StartIcon={FiNavigation} size="icon" color="minimal" />
          <Button StartIcon={FiClipboard} size="icon" color="minimal" />
        </ButtonGroup>
      </VariantRow>
