...
<Examples
  ...
  <Example title="Default">
    <ButtonGroup>
      <Button StartIcon={(props) => <Icon {...props} name="trash" />} variant="icon" color="secondary" />
      <Button StartIcon={(props) => <Icon {...props} name="navigation" />} variant="icon" color="secondary" />
      <Button StartIcon={(props) => <Icon {...props} name="clipboard" />} variant="icon" color="secondary" />
    </ButtonGroup>
  </Example>
  ...
  <Story name="All Variants">
    <VariantsTable titles={["Default", "Secondary", "Minimal"]} columnMinWidth={150}>
      <VariantRow variant="Default">
        <ButtonGroup>
          <Button StartIcon={(props) => <Icon {...props} name="trash" />} variant="icon" />
          <Button StartIcon={(props) => <Icon {...props} name="navigation" />} variant="icon" />
          <Button StartIcon={(props) => <Icon {...props} name="clipboard" />} variant="icon" />
        </ButtonGroup>
        <ButtonGroup>
          <Button StartIcon={(props) => <Icon {...props} name="trash" />} variant="icon" color="secondary" />
          <Button
            StartIcon={(props) => <Icon {...props} name="navigation" />}
            variant="icon"
            color="secondary"
          />
          <Button
        ...
        <ButtonGroup>
          <Button StartIcon={(props) => <Icon {...props} name="trash" />} variant="icon" color="minimal" />
          <Button
            StartIcon={(props) => <Icon {...props} name="navigation" />}
            variant="icon"
            color="minimal"
      ...
      <VariantsTable titles={[`${color}`]} columnMinWidth={150}>
        <VariantRow variant="">
          <ButtonGroup combined={combined}>
            <Button StartIcon={(props) => <Icon {...props} name="trash" />} variant="icon" color={color} />
            <Button
              StartIcon={(props) => <Icon {...props} name="navigation" />}
              variant="icon"
              color={color}
