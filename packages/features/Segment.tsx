...
function MatchingTeamMembers({
  ...
  if (!hasValidValue) {
    return (
      <div className="border-subtle bg-cal-muted mt-4 space-y-3 rounded-md border p-4">
  ...
  if (isPending) {
    return (
      <div
        className="border-subtle bg-cal-muted mt-4 space-y-3 rounded-md border p-4"
