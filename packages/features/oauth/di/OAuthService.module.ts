...
import { moduleLoader as refreshTokenRepositoryModuleLoader } from "./RefreshTokenRepository.module";
...
const token: symbol = OAUTH_DI_TOKENS.OAUTH_SERVICE;
const moduleToken: symbol = OAUTH_DI_TOKENS.OAUTH_SERVICE_MODULE;
...
const loadModule: (container: import("@evyweb/ioctopus").Container) => void = bindModuleToClassOnToken({
  ...
  depsMap: {
    ...
    refreshTokenRepository: refreshTokenRepositoryModuleLoader,
  },
});
