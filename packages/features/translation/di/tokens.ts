export const TRANSLATION_DI_TOKENS = {
  ...
  WORKFLOW_STEP_TRANSLATION_REPOSITORY: Symbol("WorkflowStepTranslationRepository"),
  WORKFLOW_STEP_TRANSLATION_REPOSITORY_MODULE: Symbol("WorkflowStepTranslationRepositoryModule"),
