...
export function FiltersProvider({ children }: {
    ...
    const { startTime, endTime, teamId, userId, eventTypeId, filter, memberUserId } = Object.fromEntries(searchParams?.entries() ?? []);
    ...
    const { dateRange, selectedTimeView, selectedMemberUserId, selectedTeamId, selectedUserId, selectedEventTypeId, selectedFilter, selectedTeamName, isAll, initialConfig, } = configFilters;
    return (<FilterProvider value={{
            ...
            setConfigFilters: (newConfigFilters) => {
                ...
                const { selectedMemberUserId, selectedTeamId, selectedUserId, selectedEventTypeId, selectedFilter, isAll, dateRange, } = newConfigFilters;
