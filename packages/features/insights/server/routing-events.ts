  ...
  static async getRoutingFormPaginatedResponsesForDownload({
    ...
    const dataWithFlatResponse = data.data.map((item) => {
      ...
      return {
        ...
        "Submitted At_iso": item.createdAt.toISOString(),
        ...
        "Booking Created At_iso": item.bookingCreatedAt?.toISOString() || "",
        "Booking Start Time": item.bookingStartTime?.toString() || "",
        "Booking Start Time_iso": item.bookingStartTime?.toISOString() || "",
        "Booking End Time": item.bookingEndTime?.toString() || "",
        "Booking End Time_iso": item.bookingEndTime?.toISOString() || "",
