 ...
 */
export declare const useScheduleForEvent: ({ prefetchNextMonth, username, eventSlug, eventId, month, duration, monthCount, dayCount, selectedDate, orgSlug, teamMemberEmail, }?: {
    prefetchNextMonth?: boolean | undefined;
    username?: string | null | undefined;
    ...
    data: import("@calcom/trpc/server/routers/viewer/slots/util").IGetAvailableSlots | undefined;
    isPending: boolean;
    isError: boolean;
    isSuccess: boolean;
    isLoading: boolean;
