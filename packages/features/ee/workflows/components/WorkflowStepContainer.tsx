...
import { Info, Phone, CircleHelp } from "lucide-react";
                ...
                <div>
                  ...
                  {arePhoneNumbersActive.length > 0 ? (
                    <div className="flex items-center gap-2">
                      <Phone className="text-emphasis h-4 w-4" />
                    ...
                    <>
                      <div className="bg-attention rounded-lg p-3">
                        <div className="flex items-start gap-2">
                          <Info className="text-attention mt-0.5 h-4 w-4" />
                      ...
                      {relevantPhoneNumbers.map((phone) => (
                        <div key={phone.phoneNumber} className="p-3 rounded-lg bg-cal-muted">
                          <div className="flex gap-2 items-center">
                            <Phone className="w-4 h-4 text-emphasis" />
