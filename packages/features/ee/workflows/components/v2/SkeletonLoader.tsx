...
function SkeletonLoader() {
  return (
    <ul className="mt-16 animate-pulse divide-y divide-neutral-200 rounded-md border border-gray-200 bg-white sm:overflow-hidden">
      <SkeletonItem />
      <SkeletonItem />
      <SkeletonItem />
    </ul>
        ...
        <div className="flex">
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex">
              ...
              <SkeletonText className="mr-2 h-4 w-40" />
