...
const AddNewOrganizationAdmins = () => {
  ...
  if (session.status === "loading" || !teamQuery.data) return <AddNewOrganizationAdminSkeleton />;

  return <AddNewOrganizationAdminsForm defaultValues={{ members: teamQuery.data.members }} teamId={teamId} />;
};

export const AddNewOrganizationAdminsForm = ({
  defaultValues,
  teamId,
}: {
...
export default AddNewOrganizationAdmins;

const AddNewOrganizationAdminSkeleton = () => {
  return (
