...
export const SEND_DUNNING_CANCELLATION_EMAIL_JOB_ID = "billing.send-dunning-cancellation-email";

export const sendDunningCancellationEmail: TaskWithSchema<
  typeof SEND_DUNNING_CANCELLATION_EMAIL_JOB_ID,
  typeof sendDunningEmailSchema
> = schemaTask({
  id: SEND_DUNNING_CANCELLATION_EMAIL_JOB_ID,
