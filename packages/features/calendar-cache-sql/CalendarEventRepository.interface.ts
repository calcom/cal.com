...
export interface ICalendarEventRepository {
  upsertEvent(data: Prisma.CalendarEventUpsertArgs, subscriptionId: string): Promise<CalendarEvent>;
  ...
  bulkUpsertEvents(events: Prisma.CalendarEventUpsertArgs[], subscriptionId: string): Promise<void>;
