      ...
      const mockSubscriptions = [
        {
          ...
          googleChannelId: "channel1",
          googleChannelKind: "api#channel",
          googleChannelResourceId: "resource1",
          googleChannelResourceUri: "uri1",
          googleChannelExpiration: "2024-12-31T23:59:59Z",
        ...
        },
        {
          ...
          googleChannelId: "channel2",
          googleChannelKind: "api#channel",
          googleChannelResourceId: "resource2",
          googleChannelResourceUri: "uri2",
          googleChannelExpiration: "2024-12-31T23:59:59Z",
      ...
      const mockEvents = [
        {
          ...
          createdAt: new Date(),
          updatedAt: new Date(),
          googleCreatedAt: new Date(),
          googleUpdatedAt: new Date(),
        },
        {
          id: "event2",
          calendarSubscriptionId: "sub2",
          googleEventId: "google-event2",
          iCalUID: "ical2",
          etag: "etag2",
          sequence: 0,
          summary: "Meeting 2",
