    ...
    <>
      <nav
        className={classNames(
          "pwa:pb-[max(0.25rem,env(safe-area-inset-bottom))] pwa:-mx-2 bg-muted border-subtle visible fixed bottom-0 left-0 z-30 flex w-full border-t bg-opacity-40 px-1 opacity-100 shadow backdrop-blur-md md:hidden",
          isEmbed && "hidden"
        )}>
