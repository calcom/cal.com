  ...
  const buttonContent = (
    <button
      ...
      className={classNames(
        "disabled:text-bookinglighter absolute bottom-0 left-0 right-0 top-0 mx-auto w-full rounded-md border-2 border-transparent text-center text-sm font-medium transition cursor-pointer disabled:cursor-default disabled:border-transparent disabled:font-light ",
        active
