...
function roundX(x: number, roundBy: number): number {
...
function BlockedBeforeToday({ day, startHour, endHour }: BlockedDayProps): JSX.Element {
  return (
    <>
...
function BlockedToday({
  ...
  gridCellsPerHour,
  endHour,
}: BlockedDayProps & { gridCellsPerHour: number }): JSX.Element {
...
export function BlockedList({ day }: Props): JSX.Element {
