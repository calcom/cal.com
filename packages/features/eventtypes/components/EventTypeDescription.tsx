...
export const EventTypeDescription = ({
  ...
  return (
    <>
      <div className={classNames("dark:text-darkgray-800 text-subtle", className)}>
        {eventType.description && (
          <div
            className={classNames(
              "dark:text-darkgray-800 text-subtle max-w-[280px] break-words py-1 text-sm sm:max-w-[500px] [&_a]:text-blue-500 [&_a]:underline [&_a]:hover:text-blue-600",
