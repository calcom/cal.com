  ...
  if (isLoading) {
    return (
      <div className="space-y-6 p-6">
        <h1 className="text-2xl font-bold">Experiments Playground</h1>
    ...
    return (
      <div className="space-y-6 p-6">
        ...
        <Card className="p-6">
          ...
          <pre className="bg-subtle mt-4 rounded p-4 text-xs">
      ...
      <Card className="p-6 space-y-4">
        <div>
          ...
          <div className="bg-subtle rounded p-4 space-y-2">
            <p className="text-sm">
              <span className="text-subtle">Experiment:</span> <strong>test-experiment</strong>
            </p>
            <p className="text-sm">
              <span className="text-subtle">Variant:</span> <strong className="text-emphasis">{variant}</strong>
            </p>
            <p className="text-sm">
              <span className="text-subtle">Assignment Type:</span> <strong>{assignmentType}</strong>
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-subtle text-sm">Conversions tracked: {conversions}</span>
          </div>
        </div>

        <div>
          <h2 className="text-lg font-semibold mb-2">How it works</h2>
          <ul className="text-subtle text-sm space-y-2 list-disc list-inside">
