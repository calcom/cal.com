...
export const DI_TOKENS = {
  ...
  ASSIGNMENT_REASON_REPOSITORY_MODULE: Symbol("AssignmentReasonRepositoryModule"),
    ...
    BOOKING_REFERENCE_REPOSITORY_MODULE: Symbol("BookingReferenceRepositoryModule"),
        ...
        PHONE_NUMBER_REPOSITORY: Symbol("PhoneNumberRepository"),
        ...
        ROLE_REPOSITORY_MODULE: Symbol("RoleRepositoryModule"),
        PERMISSION_REPOSITORY: Symbol("PermissionRepository"),
        PERMISSION_REPOSITORY_MODULE: Symbol("PermissionRepositoryModule"),
