...
import { moduleLoader as bookingAuditTaskerModuleLoader } from "@calcom/features/booking-audit/di/BookingAuditTasker.module";
...
const loadModule = bindModuleToClassOnToken({
  ...
  depsMap: {
    bookingAuditTasker: bookingAuditTaskerModuleLoader,
