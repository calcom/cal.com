...
/**
 * Host No-Show Updated Audit Action Helper Service
 * Handles HOST_NO_SHOW_UPDATED action
 */
export class HostNoShowUpdatedAuditActionHelperService {
...
export type HostNoShowUpdatedAuditData = z.infer<typeof HostNoShowUpdatedAuditActionHelperService.schema>;
