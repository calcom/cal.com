...
// This is the schema for DB value, here we use UNKNOWN in case client didn't pass an explcit action source.
...
export const ValidActionSourceSchema = z.enum(["API_V1", "API_V2", "WEBAPP", "WEBHOOK", "MAGIC_LINK"]);
