              ...
              <div className="px-3 mb-2">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <h3
                      className={`text-sm font-medium leading-4 ${log.hasError ? "text-subtle" : "text-emphasis"}`}>
                      {log.hasError && (
                        <Icon name="alert-triangle" className="inline-block h-3 w-3 mr-1 text-attention" />
                      )}
                  ...
                  {!log.hasError && isExpanded && (
                    <div className="bg-default rounded-lg m-0.5 text-xs">
                      ...
                      <div className="flex items-start gap-2 py-2 px-3 border-b border-subtle">
                        <span className="font-medium text-emphasis min-w-[80px]">{t("timestamp")}</span>
