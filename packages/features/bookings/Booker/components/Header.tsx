    ...
    return [
      {
        ...
        label: <Icon name="calendar" width="16" height="16" aria-label={t("switch_monthly")} />,
        tooltip: t("switch_monthly"),
      },
      {
        value: BookerLayouts.WEEK_VIEW,
        label: <Icon name="grid-3x3" width="16" height="16" aria-label={t("switch_weekly")} />,
        tooltip: t("switch_weekly"),
      },
      {
        value: BookerLayouts.COLUMN_VIEW,
        label: <Icon name="columns-3" width="16" height="16" aria-label={t("switch_columnview")} />,
