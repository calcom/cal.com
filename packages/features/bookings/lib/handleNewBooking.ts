...
import type { BookingHandlerInput } from "@calcom/features/bookings/lib/service/BookingCreateService/types";
...
export class BookingCreateService {
  ...
  async handle(
    ...
    const { prismaClient, bookingRepository, cacheService, checkBookingAndDurationLimitsService } = this.deps;
