...
describe("BookingValidationService", () => {
  ...
  describe("when validating a standard booking", () => {
    it("should successfully validate and return complete booking details", async () => {
      const context = {
    ...
    it("should validate booking with logged in user context", async () => {
      const context = {
        rawBookingData: bookingTestData.bookingData,
        rawBookingMeta: bookingTestData.bookingMeta,
        eventType: { id: 1, slug: "test-event" },
  ...
  describe("when validating platform bookings", () => {
