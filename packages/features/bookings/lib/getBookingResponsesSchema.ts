...
import type { eventTypeBookingFields, emailSchemaRefinement } from "@calcom/prisma/zod-utils";
  ...
  const preprocessed = z.preprocess(
    ...
    schema.superRefine((responses, ctx) => {
      ...
      eventType.bookingFields.forEach((bookingField) => {
        ...
        const emailSchema = isPartialSchema ? z.string() : z.string().email().refine(emailSchemaRefinement);
