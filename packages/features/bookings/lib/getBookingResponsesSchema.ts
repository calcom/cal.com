  ...
  const preprocessed = z.preprocess(
    (responses) => {
      ...
      eventType.bookingFields.forEach((field) => {
        ...
        // TODO: Move all the schemas along with their respective types to fieldTypeSchema, that would make schemas shared across Routing Forms builder and Booking Question Form builder
        if (fieldTypeSchema) {
