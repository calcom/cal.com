...
import type { EventActuallyUsed, BookingCreateBody, RecurringBookingCreateBody } from "../../types";

export type BookingOptions = {
  values: Record<string, unknown>;
  event: Pick<EventActuallyUsed, "id" | "length" | "slug" | "schedulingType" | "recurringEvent">;
  date: string;
