 ...
 * This handles confirmed bookings (scheduled emails), pending bookings (request emails), rescheduled bookings (rescheduled emails), and cancelled bookings (cancelled emails)
 */
