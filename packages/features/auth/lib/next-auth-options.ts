...
export const getOptions = async ({
  ...
  const ImpersonationProvider = await import("@calcom/features/ee/impersonation/lib/ImpersonationProvider");
  ...
  return {
    ...
    jwt: {
      ...
      encode: async ({ token, maxAge, secret }) => {
        ...
        const { default: encode } = await import("next-auth/jwt");
      ...
      async jwt({
        ...
        if (account.type === "oauth") {
          ...
          if (
            ...
            const updateProfilePhotoGoogle = await import(
              "@calcom/app-store/_utils/oauth/updateProfilePhotoGoogle"
            );
