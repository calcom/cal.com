...
import { withRoutingTrace, RoutingTraceService } from "@calcom/features/routing-trace/di/RoutingTraceService.container";
    ...
    try {
      ...
      if (!isBookingDryRun) {
        try {
          ...
          log.warn("Failed to save routing trace", safeStringify(traceError));
        }
      }
    } catch (e) {
