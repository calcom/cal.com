...
export interface DunningPauseEmailProps {
  user: {
    name: string;
    email: string;
    t: TFunction;
...
export const DunningPauseEmail = (props: DunningPauseEmailProps) => {
  const { user, team, invoiceUrl } = props;
  const { t } = user;

  return (
    <CossBaseEmailHtml subject={t("dunning_pause_email_subject")}>
      <h1 style={{ margin: "0 0 24px", fontSize: "22px", fontWeight: 600, lineHeight: "1.3" }}>
        {t("dunning_pause_email_subject")}
      </h1>
      ...
      <p style={{ margin: "0 0 16px" }}>{t("dunning_pause_email_body")}</p>

      <p style={{ margin: "0 0 32px" }}>
        {t("dunning_pause_email_body_2")}
      </p>
      ...
      <p style={{ margin: "0 0 4px", fontSize: "13px", color: "#a1a1aa" }}>
        {t("dunning_pause_email_footer")}
      </p>
      <p style={{ margin: "0", fontSize: "13px", color: "#a1a1aa" }}>
        {t("dunning_pause_email_footer_2")}
      </p>
    </CossBaseEmailHtml>
  );
};
