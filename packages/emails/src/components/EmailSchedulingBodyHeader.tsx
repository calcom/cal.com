...
export const getHeadImage = (headerType: BodyHeadType): string => {
  switch (headerType) {
    case "checkCircle":
      return `${WEBAPP_URL}/emails/checkCircle@2x.png`;
    case "xCircle":
      return `${WEBAPP_URL}/emails/xCircle@2x.png`;
    case "calendarCircle":
      return `${WEBAPP_URL}/emails/calendarCircle@2x.png`;
    case "teamCircle":
      return `${WEBAPP_URL}/emails/teamCircle@2x.png`;
  }
};
