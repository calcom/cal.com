    ...
    <Html>
      ...
      <body style={{ wordSpacing: "normal", backgroundColor: "#F3F4F6" }}>
        <div style={{ backgroundColor: "#F3F4F6" }}>
          ...
          <div style={{ height: "16px", lineHeight: "16px", fontSize: "1px" }}>{"\u00A0"}</div>
          <div style={{ margin: "0px auto", maxWidth: 600, backgroundColor: "#2E4F4F", borderRadius: "8px" }}>
            <table
              role="presentation"
              cellPadding="0"
              cellSpacing="0"
              ...
              <tbody>
                <tr>
                  <td
                    align="center"
                    style={{ padding: "24px 25px 26px 25px", fontFamily: "Arial, Helvetica, sans-serif" }}>
                    <div
                      style={{
                        fontSize: "15px",
                        fontWeight: "bold",
