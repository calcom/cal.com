...
ARG DATABASE_URL=postgresql://calcom:i55S2pBL@calcom.postgres.database.azure.com:5432/calcom
ARG NEXTAUTH_SECRET=LiCo7p05v4mRXiG17So7V8aRc2ka1hQgKYeohu1yrXs=
ARG CALENDSO_ENCRYPTION_KEY=3x7Fcejr5h4utmiKWR76BC/Cog9sdU0eeJEj+nzBndo=
