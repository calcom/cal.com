...
ARG NEXT_PUBLIC_META_WHATSAPP_BUSINESS_APP_ID
ARG NEXT_PUBLIC_META_WHATSAPP_BUSINESS_CONFIG_ID
...
export NEXT_PUBLIC_META_WHATSAPP_BUSINESS_APP_ID=${NEXT_PUBLIC_META_WHATSAPP_BUSINESS_APP_ID} && \
export NEXT_PUBLIC_META_WHATSAPP_BUSINESS_CONFIG_ID=${NEXT_PUBLIC_META_WHATSAPP_BUSINESS_CONFIG_ID} && \
...
export NEXT_PUBLIC_CLOUDFLARE_SITEKEY=${NEXT_PUBLIC_CLOUDFLARE_SITEKEY} && \
