...
ENV NEXT_PUBLIC_WEBAPP_URL=http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER \
  ...
  NEXT_PUBLIC_WEBSITE_TERMS_URL=http://NEXT_PUBLIC_WEBSITE_TERMS_URL_PLACEHOLDER \
  NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL=http://NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL_PLACEHOLDER \
...
# Save value used during this build stage. If values differ at run-time, start.sh will find/replace.
ENV NEXT_PUBLIC_WEBAPP_URL=$NEXT_PUBLIC_WEBAPP_URL \
  BUILT_NEXT_PUBLIC_WEBAPP_URL=$NEXT_PUBLIC_WEBAPP_URL \
  NEXT_PUBLIC_WEBSITE_TERMS_URL=$NEXT_PUBLIC_WEBSITE_TERMS_URL \
  BUILT_NEXT_PUBLIC_WEBSITE_TERMS_URL=$NEXT_PUBLIC_WEBSITE_TERMS_URL \
  NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL=$NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL \
  BUILT_NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL=$NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL

RUN scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBAPP_URL}
RUN scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBSITE_TERMS_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBSITE_TERMS_URL}
RUN scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL}
