...
it("email html should render invite email", () => {
  ...
  expect(result).toContain('If you prefer not to use \"hello@example.com\" as your Cal.com email or already have a Cal.com account, please request another invitation to that email.');
})