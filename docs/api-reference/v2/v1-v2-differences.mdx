...
<Note>
V2 API only supports API key authentication for regular webapp users. OAuth and managed user authentication are for the Platform product, not regular users.
</Note>
