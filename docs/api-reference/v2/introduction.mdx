...
### 2. Platform OAuth (for API authentication)

Platform OAuth is another form of authentication for the Cal.com API. This is different from OAuth for apps and integrations. For more information about OAuth for apps, see the [OAuth for apps documentation](https://cal.com/help/apps-and-integrations/oauth).
