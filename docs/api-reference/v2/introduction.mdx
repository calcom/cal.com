...
<Note>
This section covers **platform OAuth** for API authentication (another form of authentication for the Cal.com API). If you're looking for information about OAuth for apps and integrations, see the [OAuth for apps documentation](https://cal.com/help/apps-and-integrations/oauth).
</Note>
