...
<Note>
This section covers **platform OAuth** for API authentication. If you're looking for information about OAuth for apps and integrations, see the [OAuth for apps documentation](https://cal.com/help/apps-and-integrations/oauth).
</Note>
