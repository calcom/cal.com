...
| `scope` | Optional | Space-separated list of scopes to request (e.g. `BOOKING_READ BOOKING_WRITE`). Must be a subset of scopes enabled on the OAuth client. If omitted, all client scopes are used. |
