...
<Warning>
  **API v1 was shut down on April 8, 2026.** All v1 endpoints have been removed from the codebase. Use this guide to migrate any remaining v1 integrations to API v2.
</Warning>
...
- **V2**: Available and required for all integrations
- **April 8, 2026**: V1 was permanently shut down and removed

If you still have v1 integrations, migrate them now using this guide to restore functionality.