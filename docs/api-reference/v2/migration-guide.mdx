...
- **Higher rate limits**: OAuth-based authentication supports up to 500 requests per minute
...
### V2 authentication
V2 offers three authentication methods with improved security:
...
#### 2. OAuth client credentials (for platform customers)
```bash
curl https://api.cal.com/v2/platform/managed-users \
...
| OAuth Client Credentials | N/A | 500 req/min |
| Managed User Access Token | N/A | 500 req/min |
...
<Steps>
  ...
  <Step title="Monitor and optimize">
    Take advantage of higher rate limits and new features to optimize your integration
  </Step>
</Steps>
