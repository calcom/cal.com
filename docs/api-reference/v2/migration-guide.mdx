...
<Warning>
  **API v1 is deprecated and will be permanently shut down on April 8, 2026.** Please migrate to API v2 as soon as possible.
</Warning>
...
- **April 8, 2026**: V1 will be permanently shut down
