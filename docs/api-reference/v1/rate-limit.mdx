...
<Warning>
**API v1 has been shut down as of April 8, 2026.** All v1 endpoints have been removed. Please use [API v2](/api-reference/v2/introduction) for all integrations. If you are migrating from v1, see the [migration guide](/api-reference/v2/migration-guide).
</Warning>
