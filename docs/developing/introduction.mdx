...
<CardGroup cols={2}>
    ...
    <Card href="/developing/guides/request-flow-booking" title="Request flows" icon="arrows-right-left">
        Booking create, reschedule, cancel request flows (Mermaid diagrams)
    </Card>
</CardGroup>
