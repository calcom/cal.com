...
| availabilityLoaded   | When event availability data is loaded and ready.                                                     | `eventId: number` // Event Type ID <br /> `eventSlug: string` // Event Type slug <br /> `eventTitle: string` // Event Type title |
