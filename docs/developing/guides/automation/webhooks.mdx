...
### Wrong Assignment Report webhook payload
...
| ----- | ---- | ----------- |
| booking.uid | String | Unique identifier of the booking |
| booking.id | Number | Internal booking ID |
| booking.title | String | Title of the booking |
| booking.startTime | Datetime | Start time of the booking |
| booking.endTime | Datetime | End time of the booking |
| booking.status | String | Status of the booking (e.g., ACCEPTED, PENDING) |
| booking.eventType | Object | Event type details including id, title, slug, and teamId |
| report.reportedBy | Object | User who reported the wrong assignment (id, email, name) |
| report.routingReason | String | The routing reason that was used to assign this booking |
| report.guest | String | Email of the guest who booked |
| report.host | Object | Current host details (email, name) |
| report.correctAssignee | String | Email of who should have received the booking (optional) |
| report.additionalNotes | String | Additional context provided by the reporter |
