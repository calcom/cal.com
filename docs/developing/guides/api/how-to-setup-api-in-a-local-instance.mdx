...
1. Cal.com repo clone. You can get it by following the instructions provided in [Installation](/developing/local-development)
...
3. Next, you need to install API submodule by following the instructions provided in [API submodule](/developing/local-development#api)
