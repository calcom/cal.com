...
1. Create a SAML application with your Identity Provider (IdP) using the instructions here - [SAML Setup](/developing/guides/auth-and-provision/sso-setup#saml-registration-with-identity-providers)
