...
**For Platform customers:** You must use OAuth credentials or managed user access tokens - never API keys. This is critical because OAuth authentication ensures all data created through the API is properly attached to your OAuth client, maintaining data integrity and proper attribution in your Platform integration.
