...
<CardGroup cols={2}>
  <Card href="/platform/event-types-hooks" title="Previous: Event Types Hooks" icon="arrow-left">
    Hooks for event types
  </Card>
  <Card href="/platform/user-or-team-related-hooks" title="Next: User/Teams Hooks" icon="arrow-right">
    Hooks for users and teams
  </Card>
</CardGroup>