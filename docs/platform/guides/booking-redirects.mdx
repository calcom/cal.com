...
<CardGroup cols={2}>
  <Card href="/platform/user-or-team-related-hooks" title="Previous: User/Teams Hooks" icon="arrow-left">
    Hooks for users and teams
  </Card>
  <Card href="/platform/guides/booking-fields" title="Next: Booking Fields" icon="arrow-right">
