...
<CardGroup cols={2}>
  <Card href="/platform/guides/replacing-toasts" title="Previous: Custom Toasts" icon="arrow-left">
    Replace default toasts
  </Card>
  <Card href="/platform/guides/global-event-types" title="Next: Global Event Types" icon="arrow-right">
    Shared event types
  </Card>
</CardGroup>
