...
description: Learn how to set up teams via API v2
---

This page guides you through the steps to set up teams via API v2. An organization is just a team that can have children teams.
