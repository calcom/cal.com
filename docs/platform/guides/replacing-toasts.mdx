...
<CardGroup cols={2}>
  <Card href="/platform/guides/custom-slot-select-flow" title="Previous: Custom Slot Selection" icon="arrow-left">
    Intercept slot selection
  </Card>
  <Card href="/platform/guides/teams-setup" title="Next: Teams Setup" icon="arrow-right">
    Configure your team
  </Card>
</CardGroup>
