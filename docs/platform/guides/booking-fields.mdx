...
{% img src="/docs/images/platform/guides/booking-fields/default-fields/booker.png" /%}
...
{% img src="/docs/images/platform/guides/booking-fields/custom-fields/request.png" /%}

That looks in booker like:
{% img src="/docs/images/platform/guides/booking-fields/custom-fields/booker.png" /%}
...
which now will populat the booking fields:
{% img src="/docs/images/platform/guides/booking-fields/custom-fields/prefilled.png" /%}

## Making pre-filled fields read-only
`disableOnPrefill` booking field property controlls whether or not not make a booking field read only if we pass its value in the defaultFormValues prop. Here is an example request
...
{% img src="/docs/images/platform/guides/booking-fields/read-only/request.png" /%}
...
{% img src="/docs/images/platform/guides/booking-fields/read-only/prefilled.png" /%}
