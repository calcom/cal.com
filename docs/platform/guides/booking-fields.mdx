...
<CardGroup cols={2}>
  <Card href="/platform/guides/booking-redirects" title="Previous: Booking Redirects" icon="arrow-left">
    Manage booking flow
  </Card>
  <Card href="/platform/guides/custom-booking-flow" title="Next: Custom Booking Flow" icon="arrow-right">
    Intercept bookings
  </Card>
</CardGroup>
