...
<Step title="You're ready"> 
    Once you subscribe via stripe, you will be redirected back to the platform setup page where you'll be able to see your platform dashboard. You're ready to start building with platform, head over to <a href="/platform/quickstart">Quickstart</a> for further steps.
