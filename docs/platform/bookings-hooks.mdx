...
<CardGroup cols={2}>
  <Card href="/platform/atoms/troubleshooter" title="Previous: Troubleshooter" icon="arrow-left">
    Debug availability issues
  </Card>
  <Card href="/platform/event-types-hooks" title="Next: Event Types Hooks" icon="arrow-right">
