...
<Note>In order to create a team event type, you need to be a team admin or owner.</Note>

### 9. `useConnectedCalendars`
...
### 12. `useDeleteCalendarCredentials`
