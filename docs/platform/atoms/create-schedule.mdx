...
<CardGroup cols={2}>
  <Card href="/platform/atoms/availability-settings" title="Previous: Availability Settings" icon="arrow-left">
    Set availability
  </Card>
  <Card href="/platform/atoms/list-schedules" title="Next: List Schedules" icon="arrow-right">
    Display schedules
  </Card>
</CardGroup>
