...
<CardGroup cols={2}>
  <Card href="/platform/atoms/stripe-connect" title="Previous: Stripe Connect" icon="arrow-left">
    Payment integration
  </Card>
  <Card href="/platform/atoms/troubleshooter" title="Next: Troubleshooter" icon="arrow-right">
