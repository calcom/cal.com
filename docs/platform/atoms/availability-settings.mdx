...
<CardGroup cols={2}>
  <Card href="/platform/atoms/list-event-types" title="Previous: List Event Types" icon="arrow-left">
    Display event types
  </Card>
  <Card href="/platform/atoms/create-schedule" title="Next: Create Schedule" icon="arrow-right">
