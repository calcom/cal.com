...
<CardGroup cols={2}>
  <Card href="/platform/atoms/calendar-view" title="Previous: Calendar View" icon="arrow-left">
    Calendar display
  </Card>
  <Card href="/platform/atoms/outlook-calendar-connect" title="Next: Outlook Calendar Connect" icon="arrow-right">
