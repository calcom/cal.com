...
<CardGroup cols={2}>
  <Card href="/platform/atoms/booker-embed" title="Previous: Booker Embed" icon="arrow-left">
    Embedding the booker
  </Card>
  <Card href="/platform/atoms/list-event-types" title="Next: List Event Types" icon="arrow-right">
    Display event types
  </Card>
</CardGroup>
