...
<Note>
  Required props vary by usage: <br />
  1. Individual booking: `username` + `eventSlug` <br />
...
<CardGroup cols={2}>
  <Card href="/platform/atoms/booker" title="Previous: Booker" icon="arrow-left">
    Booker atom
  </Card>
  <Card href="/platform/atoms/event-type" title="Next: Event Type" icon="arrow-right">
    Event type settings
  </Card>
</CardGroup>
