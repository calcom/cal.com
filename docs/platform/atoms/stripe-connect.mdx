...
<CardGroup cols={2}>
  <Card href="/platform/atoms/conferencing-apps" title="Previous: Conferencing Apps" icon="arrow-left">
    Video conferencing integration
  </Card>
  <Card href="/platform/atoms/payment-form" title="Next: Payment Form" icon="arrow-right">
    Process payments
  </Card>
</CardGroup>
