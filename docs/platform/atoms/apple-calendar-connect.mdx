...
<CardGroup cols={2}>
  <Card href="/platform/atoms/outlook-calendar-connect" title="Previous: Outlook Calendar Connect" icon="arrow-left">
    Connect Outlook Calendar
  </Card>
  <Card href="/platform/atoms/conferencing-apps" title="Next: Conferencing Apps" icon="arrow-right">
