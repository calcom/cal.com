...
<CardGroup cols={2}>
  <Card href="/platform/atoms/cal-oauth-provider" title="Previous: Cal OAuth Provider" icon="arrow-left">
    OAuth provider setup
  </Card>
  <Card href="/platform/atoms/booker-embed" title="Next: Booker Embed" icon="arrow-right">
    Embedding the booker
  </Card>
</CardGroup>
