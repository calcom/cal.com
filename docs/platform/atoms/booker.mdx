...
| silentlyHandleCalendarFailures     | No       | Boolean when true the booker still displays slots when the third party calendars credentials are invalid or expiredmay, booker may show stale availability when enabled                             |
