...
<CardGroup cols={2}>
  <Card href="/platform/atoms/event-type" title="Previous: Event Type" icon="arrow-left">
    Event type settings
  </Card>
  <Card href="/platform/atoms/availability-settings" title="Next: Availability Settings" icon="arrow-right">
    Set availability
  </Card>
</CardGroup>
