...
<CardGroup cols={2}>
  <Card href="/platform/quickstart" title="Previous: Quickstart" icon="arrow-left">
    Getting started with atoms
  </Card>
  <Card href="/platform/atoms/cal-oauth-provider" title="Next: Cal OAuth Provider" icon="arrow-right">
