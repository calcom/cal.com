...
<CardGroup cols={2}>
  <Card href="/platform/atoms/list-schedules" title="Previous: List Schedules" icon="arrow-left">
    Display schedules
  </Card>
  <Card href="/platform/atoms/calendar-view" title="Next: Calendar View" icon="arrow-right">
    Calendar display
  </Card>
</CardGroup>
