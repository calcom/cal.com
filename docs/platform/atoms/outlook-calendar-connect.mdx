...
<CardGroup cols={2}>
  <Card href="/platform/atoms/google-calendar-connect" title="Previous: Google Calendar Connect" icon="arrow-left">
    Connect Google Calendar
  </Card>
  <Card href="/platform/atoms/apple-calendar-connect" title="Next: Apple Calendar Connect" icon="arrow-right">
