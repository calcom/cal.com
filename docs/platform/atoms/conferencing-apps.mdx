...
<CardGroup cols={2}>
  <Card href="/platform/atoms/apple-calendar-connect" title="Previous: Apple Calendar Connect" icon="arrow-left">
    Connect Apple Calendar
  </Card>
  <Card href="/platform/atoms/stripe-connect" title="Next: Stripe Connect" icon="arrow-right">
    Payment integration
  </Card>
</CardGroup>