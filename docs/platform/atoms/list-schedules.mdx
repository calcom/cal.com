...
<CardGroup cols={2}>
  <Card href="/platform/atoms/create-schedule" title="Previous: Create Schedule" icon="arrow-left">
    Create new schedules
  </Card>
  <Card href="/platform/atoms/calendar-settings" title="Next: Calendar Settings" icon="arrow-right">
