...
<CardGroup cols={2}>
  <Card href="/platform/atoms/payment-form" title="Previous: Payment Form" icon="arrow-left">
    Process payments
  </Card>
  <Card href="/platform/bookings-hooks" title="Next: Bookings Hooks" icon="arrow-right">
    Hooks for bookings
  </Card>
</CardGroup>