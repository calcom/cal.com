...
<CardGroup cols={2}>
  <Card href="/platform/atoms/calendar-settings" title="Previous: Calendar Settings" icon="arrow-left">
    Calendar configuration
  </Card>
  <Card href="/platform/atoms/google-calendar-connect" title="Next: Google Calendar Connect" icon="arrow-right">
