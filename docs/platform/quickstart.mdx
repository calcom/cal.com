...
<CardGroup cols={2}>
  <Card href="/platform/introduction" title="Previous: Introduction" icon="arrow-left">
    Platform overview
  </Card>
  <Card href="/platform/atoms/cal-provider" title="Next: Cal Provider" icon="arrow-right">
    Setting up Cal Provider atom
  </Card>
</CardGroup>
