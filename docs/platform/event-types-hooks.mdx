...
<CardGroup cols={2}>
  <Card href="/platform/bookings-hooks" title="Previous: Bookings Hooks" icon="arrow-left">
    Hooks for bookings
  </Card>
  <Card href="/platform/calendars-hooks" title="Next: Calendars Hooks" icon="arrow-right">
    Hooks for calendars
  </Card>
</CardGroup>
