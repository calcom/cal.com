...
The Docker configuration for Cal.com is now officially maintained in the main Cal.com repository. The Dockerfile and docker-compose.yml are located in the root of the [calcom/cal.com repository](https://github.com/calcom/cal.com).

If you want to contribute to the Docker configuration, please submit pull requests or issues to the [main Cal.com repository](https://github.com/calcom/cal.com).
...
Check out the [Cal.com repository](https://github.com/calcom/cal.com) for more detailed instructions on how to build and configure your own Docker image. The Dockerfile and docker-compose.yml are located in the root of the repository. 
