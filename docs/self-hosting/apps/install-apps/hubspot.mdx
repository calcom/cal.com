...
- **Meeting Creation**: When a booking is made in Cal.com, a meeting is automatically created in HubSpot and associated with the contact(s).
- **Contact Creation**: If an attendee doesn't exist in HubSpot, they are automatically created as a contact before being associated with the meeting.
- **No-Show Tracking**: When a booking is marked as no-show in Cal.com, the corresponding HubSpot meeting's outcome is updated to "No Show".
