...
<Steps>
  ...
  <Step title="Copy your API key">Copy the API key provided in the developers tab.</Step>
  ...
  <Step title="Set the DAILY_SCALE_PLAN variable (optional)">
    If you have the [Daily Scale Plan](https://www.daily.co/pricing), set the `DAILY_SCALE_PLAN` variable to
    `true` in the `.env` file to use features like video recording.
  </Step>
</Steps>
