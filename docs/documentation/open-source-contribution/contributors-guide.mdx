...
Cal.com can be set up and run on your machine locally. Please take a look at [this quick guide](https://cal.com/documentation/getting-started/local-development) for instructions on setting it up.
...
- [Contributor's Guide](https://cal.com/documentation/open-source-contribution/contributors-guide)
- [Code Styling Guide](https://cal.com/documentation/open-source-contribution/code-styling)
- [Pull Requests Guide](https://cal.com/documentation/open-source-contribution/pull-requests)