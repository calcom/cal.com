...
const DEFAULT_NAVIGATION_TIMEOUT = process.env.CI ? 50000 : 50000;
const DEFAULT_EXPECT_TIMEOUT = process.env.CI ? 50000 : 50000;
...
const DEFAULT_TEST_TIMEOUT = process.env.CI ? 120000 : 120000;
