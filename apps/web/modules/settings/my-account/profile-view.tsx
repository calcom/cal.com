...
const ProfileView = ({ user }: Props) => {
  ...
  // Use the same query as SettingsLayout to share cache and avoid duplicate network calls
  const { data: meData } = trpc.viewer.me.get.useQuery({ includePasswordAdded: true });
