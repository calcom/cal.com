...
export default function OutOfOfficeView() {
  ...
  const customReasons = (reasonList || [])
        ...
        <div className="flex flex-col gap-1">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex h-8 items-center">
              <Tooltip content={t("ooo_add_custom_reason_button_tooltip")} side="top">
                <Button
                  type="button"
                  color="secondary"
                  size="sm"
                  ...
                  title={t("ooo_add_custom_reason_button_title")}>
                  {t("add")}
                </Button>
              </Tooltip>
            </div>
                      ...
                      <Tooltip
                        ...
                        <span className="inline-flex">
                          <Button
                            ...
                            onClick={() => {
                              if (isReasonInUse) {
                                showToast(t("custom_reason_in_use"), "warning");
                                return;
                              }
                              deleteCustomReason.mutate({ id: r.id });
                            }}
