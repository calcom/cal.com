...
export const CompanyEmailOrganizationBanner = ({ onDismissAction }: CompanyEmailOrganizationBannerProps) => {
  ...
  return (
    <Frame>
      <FramePanel className="from-muted relative overflow-hidden bg-linear-to-r to-transparent">
        ...
        <div className="relative z-10 flex gap-4">
          ...
          <div className="flex flex-1 flex-col gap-2">
            <div className="flex flex-col">
              ...
              <p className="text-muted-foreground text-sm">{t("explore_organizational_plan_description")}</p>
            </div>
            <div className="mt-2 flex gap-2">
              <Button variant="outline" onClick={onDismissAction}>
                {t("dismiss")}
              </Button>
