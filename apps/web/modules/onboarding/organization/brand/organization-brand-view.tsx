              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex w-full flex-col gap-2">
                    <div className="bg-muted border-muted relative h-[92px] w-full overflow-hidden rounded-md border">
                      {bannerPreview && (
                        <Image src={bannerPreview} alt={t("onboarding_banner_preview_alt")} fill className="h-full w-full object-cover" />
                      )}
                    </div>
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="bg-muted border-muted relative h-16 w-16 shrink-0 overflow-hidden rounded-md border">
                    {logoPreview && (
                      <Image src={logoPreview} alt={t("onboarding_logo_preview_alt")} fill className="h-full w-full object-cover" />
                    )}
                  </div>
                  <div className="flex flex-col gap-2">
                    <Button
