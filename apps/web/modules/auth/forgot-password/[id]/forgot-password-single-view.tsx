  ...
  return (
    <>
      <div className="stack-y-6">
        <div>
          <h2 className="font-heading text-emphasis mt-6 text-center text-3xl font-extrabold">
            {t("password_updated")}
          </h2>
        </div>
...
function Expired() {
  ...
  return (
    <>
      <div className="stack-y-6">
        <div>
          <h2 className="font-heading text-emphasis mt-6 text-center text-3xl font-extrabold">{t("whoops")}</h2>
