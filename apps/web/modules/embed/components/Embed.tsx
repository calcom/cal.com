...
import { useSlotsForDate } from "@calcom/features/bookings/Booker/hooks/useSlotsForDate";
...
const ChooseEmbedTypesDialogContent = ({
  ...
  return (
    <DialogContent className="rounded-lg p-10" type="creation" size="lg">
      <div className="mb-2">
        <h3 className="font-heading text-emphasis mb-2 text-2xl font-semibold leading-none" id="modal-title">
        ...
        <div className="bg-cal-muted flex h-[95vh] w-1/3 flex-col overflow-y-auto p-8">
          ...
          {eventTypeData?.eventType && embedType === "email" ? (
            <EmailEmbed
              ...
              username={teamSlug ?? data?.user?.orgAwareUsername ?? data?.user?.username ?? ""}
