...
import { useIsQuickAvailabilityCheckFeatureEnabled } from "~/bookings/hooks/useIsQuickAvailabilityCheckFeatureEnabled";
import useSkipConfirmStep from "~/bookings/hooks/useSkipConfirmStep";
import {
  fadeInLeft,
