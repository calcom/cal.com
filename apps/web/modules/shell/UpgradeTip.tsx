...
export function UpgradeTip({
  ...
  return (
    <>
      <div className="relative flex min-h-[295px] w-full items-center justify-between overflow-hidden rounded-lg pb-10 md:min-h-[350px]">
 ...
 className="absolute min-h-full w-full select-none rounded-lg object-cover object-left md:object-[45%_30%] lg:object-center"            src={imageSrc}
         ...
         <div className="relative my-4 w-full px-4 pb-4 sm:px-8 md:px-8">
