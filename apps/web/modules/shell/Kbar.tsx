...
function useAppStoreActions(): Action[] {
...
function buildKbarActions(push: (href: string) => void, appStoreActions: Action[]): Action[] {
...
const KBarRoot = ({ children }: { children: ReactNode }): JSX.Element => {
  ...
  const actions = useMemo(
    () => buildKbarActions(router.push, appStoreActions),
    [router.push, appStoreActions]
  );
