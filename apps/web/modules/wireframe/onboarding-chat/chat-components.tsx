...
type ChatStep = "usage" | "calendar" | "complete";

const STEP_ORDER: ChatStep[] = ["usage", "calendar", "complete"];

const STEP_NUMBER: Record<ChatStep, 1 | 2 | 3> = {
  usage: 1,
  calendar: 2,
  complete: 3,
};
...
export const OnboardingChatView = ({ userEmail }: OnboardingChatViewProps) => {
  const { t } = useLocale();
