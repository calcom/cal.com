...
async function getHandler(request: NextRequest, { params }: { params: Promise<{ directory?: string[] }> }) {
  return handleScimRequest(request, "GET", (await params).directory);
}

async function postHandler(request: NextRequest, { params }: { params: Promise<{ directory?: string[] }> }) {
  return handleScimRequest(request, "POST", (await params).directory);
}

async function putHandler(request: NextRequest, { params }: { params: Promise<{ directory?: string[] }> }) {
  return handleScimRequest(request, "PUT", (await params).directory);
}

async function patchHandler(request: NextRequest, { params }: { params: Promise<{ directory?: string[] }> }) {
