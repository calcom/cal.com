// This file has been sourced from: /Users/sean/Programming/cal.com/apps/web/pages/settings/organizations/[id]/onboard-admins.tsx
...
const OnboardTeamMembersPage = () => {
    ...
    if (!router.isReady)
        return null;
    return (<>
      <Meta title={t("invite_organization_admins")} description={t("invite_organization_admins_description")}/>
      <AddNewOrgAdminsForm />
    </>);
};
OnboardTeamMembersPage.getLayout = (page: React.ReactElement, router: NextRouter) => (<WizardLayout currentStep={4} maxSteps={5} isOptionalCallback={() => {
