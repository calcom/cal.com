// This file has been sourced from: /Users/sean/Programming/cal.com/apps/web/pages/settings/security/two-factor-auth.tsx
...
const TwoFactorAuthView = () => {
    ...
    return (<>
      ...
      <div className="mt-6 flex items-start space-x-4">
        <Switch data-testid="two-factor-switch" disabled={!isCalProvider} checked={user?.twoFactorEnabled} onCheckedChange={() => user?.twoFactorEnabled ? setDisableModalOpen(true) : setEnableModalOpen(true)}/>
        <div className="!mx-4">
          <div className="flex">
      ...
      <EnableTwoFactorModal open={enableModalOpen} onOpenChange={() => setEnableModalOpen(!enableModalOpen)} onEnable={() => {
      ...
      <DisableTwoFactorModal open={disableModalOpen} onOpenChange={() => setDisableModalOpen(!disableModalOpen)} onDisable={() => {
