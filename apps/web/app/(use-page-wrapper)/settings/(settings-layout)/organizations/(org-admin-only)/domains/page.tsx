...
import SmtpConfigurationsView from "~/ee/organizations/smtp-configuration/smtp-configurations-view";
import { validateUserHasOrg } from "../../actions/validateUserHasOrg";

export const generateMetadata = async () =>
  await _generateMetadata(
    (t) => t("custom_email"),
    (t) => t("custom_email_description"),
    undefined,
    undefined,
...
const Page = async () => {
  ...
  const isCustomSmtpEnabled = await teamFeatureRepository.checkIfTeamHasFeature(
    session.user.profile.organizationId,
    "custom-smtp-for-orgs"
  );
  ...
  return (
    <SettingsHeader
      title={t("custom_email")}
      description={t("custom_email_description")}>
