    ...
    <>
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <div>
            <h3 className="text-lg font-medium">{t("team_members")}</h3>
            <div className="mt-4">
              <Button
                variant="button"
                color="secondary"
              ...
              <p className="mt-2 text-sm text-gray-500 md:hidden">{t("manage_members_desktop_only")}</p>
            </div>
          </div>
      ...
      <TeamMembersSheet team={team} open={membersSheetOpen} onOpenChange={setMembersSheetOpen} />
    </>
  );
}
