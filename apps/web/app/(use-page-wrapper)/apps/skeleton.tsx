...
export function AppsViewSkeleton() {
  const { t } = useLocale();
  return (
    <ShellMainAppDir
      heading={t("app_store")}
        ...
        <div className="flex flex-col gap-y-8">
          ...
          <div className="flex justify-end pb-4">
            <div className="w-full md:w-64">
              <SkeletonText className="h-9 w-full rounded-md" />
            </div>
          </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
              ...
              {Array(5)
                ...
                .map((_, i) => (
                  <div
                    key={`category-${i}`}
                    className="bg-subtle flex h-32 flex-col items-center justify-center rounded-md p-4">
