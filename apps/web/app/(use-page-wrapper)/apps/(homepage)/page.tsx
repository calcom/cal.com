...
const ServerPage = async () => {
  ...
  const appStore: AppFrontendPayload[] = appManifest.map((app) => ({
    ...
    publisher: app.email, // Using email as publisher since manifest doesn't have separate publisher field
    url: app.website,
    email: app.email,
    ...
    reviews: 0,
    trending: false,
    installed: false, // Default to false - should be fetched per-user for accurate status
    isDefault: false,
    installCount: 0,
