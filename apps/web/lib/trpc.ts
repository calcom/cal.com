...
import { createReactQueryHooks, TRPCClient } from "@trpc/react";
import type { inferProcedureOutput, inferProcedureInput, AnyRouter } from "@trpc/server";
...
export const trpc: TRPCProvider = createReactQueryHooks<AppRouter>();
