...
export const WEBHOOK_TRIGGER_EVENTS_GROUPED_BY_APP = {
  ...
  ] as ["BOOKING_CANCELLED", "BOOKING_CREATED", "BOOKING_RESCHEDULED", "MEETING_ENDED"],
...
] as ["BOOKING_CANCELLED", "BOOKING_CREATED", "BOOKING_RESCHEDULED", "MEETING_ENDED", "FORM_SUBMITTED"];
