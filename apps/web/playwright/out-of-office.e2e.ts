...
import { submitAndWaitForResponse, localize, gotoAndWaitForIdle } from "./lib/testUtils";
...
test.describe("Out of office", () => {
  ...
  test.describe("Team OOO", () => {
    test("Admin can create, edit and delete team member's OOO", async ({ page, users }) => {
      ...
      await gotoAndWaitForIdle(page, "/settings/my-account/out-of-office?type=team");
      await page.waitForLoadState("domcontentloaded");
      await entriesListRespPromise;
