...
export function createBookingPageFixture(page: Page) {
  return {
    ...
    removeManagedEventType: async () => {
      ...
      // Check if the correct message is shown in the dialog
      ...
      // Check if the correct image is shown when there is no event type
    ...
    deleteTeam: async () => {
      ...
      // Check if the correct image is shown when there is no team
