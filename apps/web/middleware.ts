...
export const config = {
  ...
  matcher: [
    ...
    "/apps/routing-forms",
    "/apps/routing-forms/forms/:path*",
    "/apps/routing-forms/form-edit/:path*",
    "/apps/routing-forms/route-builder/:path*",
    "/apps/routing-forms/routing-link/:path*",
    "/apps/routing-forms/reporting/:path*",
    "/apps/routing-forms/incomplete-booking/:path*",
    "/auth/:path*",
    "/event-types/:path*",
    "/workflows/:path*",
