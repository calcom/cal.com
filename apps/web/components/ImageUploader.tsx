      ...
      <DialogContent>
        ...
        <div className="mb-4">
          <div className="cropper mt-6 flex flex-col items-center justify-center p-8">
            ...
            <label className="focus:outline-none focus:ring-neutral-900 mt-8 rounded-sm border border-gray-300 bg-white px-3 py-1 text-xs font-medium leading-4 text-gray-700 hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm focus:ring-2 focus:ring-offset-1 dark:border-gray-800 dark:bg-transparent dark:text-white dark:hover:bg-gray-900">
              <input
                onInput={onInputFile}
                type="file"
                name={id}
