    ...
    <>
      {!isAnyQueryPending && (
        <>
          ...
          {firstCalendar === undefined &&
            queryIntegrations.data &&
            queryIntegrations.data.items.length > 0 && (
      ...
      <Button
        ...
        className={cn(
          "bg-active border-active dark:border-default mt-8 flex w-full flex-row justify-center rounded-md border text-center text-sm dark:bg-gray-200",
