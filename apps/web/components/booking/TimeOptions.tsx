...
const TimeOptions: FC<Props> = ({ onToggle24hClock, onSelectTimeZone, timeFormat }) => {
  ...
  return selectedTimeZone !== "" ? (
    <div className="md:max-w-80 dark:border-darkgray-300 dark:bg-darkgray-200 z-10 w-full rounded-sm border border-gray-200 bg-white px-4 pt-4 pb-3 shadow-sm">
