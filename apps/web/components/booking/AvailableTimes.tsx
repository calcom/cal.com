      ...
      {!!date ? (
        <div className="dark:bg-darkgray-100 mt-8 flex h-full w-full flex-col rounded-md px-4 text-center sm:mt-0 sm:p-4 md:-mb-5 md:min-w-[200px] md:p-4 lg:min-w-[300px]">
          <div className="mb-4 flex items-center text-left text-base">
            <div className="mr-4">
              <span className="text-bookingdarker  text-emphasis font-semibold">
                    ...
                    {seatsPerTimeSlot && slot.attendees && (slotFull || notEnoughSeats) ? (
                      <div
                        className={classNames(
                          "text-primary-500 dark:bg-darkgray-200  bg-default mb-2 block rounded-sm border py-2 font-medium opacity-25 dark:border-transparent ",
                      ...
                      <Link
                        ...
                        className={classNames(
                          ...
                          "dark:bg-darkgray-200 dark:hover:bg-darkmodebrand dark:hover:border-darkmodebrand  bg-default mb-2 block rounded-md border py-2 text-sm font-medium dark:border-transparent",
                          brand === "#fff" || brand === "#ffffff" ? "" : ""
                        )}
                        data-testid="time">
                        {dayjs(slot.time).tz(timeZone()).format(timeFormat)}
