...
function BookingListItem(booking: BookingItemProps) {
  ...
  const cancelledBookingReportAction: ActionType | null = isCancelled
      ...
      <div
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="flex w-full flex-col flex-wrap items-end justify-end space-x-2 space-y-2 py-4 pl-4 text-right text-sm font-medium ltr:pr-4 rtl:pl-4 sm:flex-row sm:flex-nowrap sm:items-start sm:space-y-0 sm:pl-0">
            ...
            {cancelledBookingReportAction && (
              <div className="flex items-center space-x-2">
                <Button
                  type="button"
                  variant="icon"
                  color="secondary"
                  StartIcon={cancelledBookingReportAction.icon}
                  onClick={cancelledBookingReportAction.onClick}
                  disabled={cancelledBookingReportAction.disabled}
                  data-testid={cancelledBookingReportAction.id}
                  className="h-8 w-8"
                  tooltip={cancelledBookingReportAction.label}
                />
              </div>
            )}
          </div>
