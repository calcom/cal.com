...
export default function AppListCard(props: AppListCardProps) {
  ...
  return !isPlatform ? <WebAppListCard {...props} /> : <AppListCardComponent {...props} highlight={false} />;
}

const WebAppListCard = (props: AppListCardProps) => {
  ...
  return <AppListCardComponent {...props} highlight={highlight} />;
};
