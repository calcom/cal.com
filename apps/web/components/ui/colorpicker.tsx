...
const ColorPicker = (props: ColorPickerProps) => {
  ...
  return (
    <div className="relative mt-1 flex items-center justify-center">
      ...
      <HexColorInput
        className="focus:border-neutral-800 focus:outline-none focus:ring-neutral-800 ml-1 block w-full rounded-sm border border-gray-300 px-3 py-2 shadow-sm sm:text-sm"
        color={color}
        onChange={(val) => {
          setColor(val);
          props.onChange(val);
