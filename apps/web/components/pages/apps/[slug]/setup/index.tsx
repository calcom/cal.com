...
type SetupInformationPageComponentFunction = {
  (props: InferGetServerSidePropsType<typeof getServerSideProps>): JSX.Element;
  PageWrapper?: (props: AppProps) => JSX.Element;
};

const SetupInformation: SetupInformationPageComponentFunction = function SetupInformation(
