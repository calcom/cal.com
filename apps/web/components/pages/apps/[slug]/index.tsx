...
type SingleAppPageComponentFunction = ((
  props: inferSSRProps<typeof getStaticProps>
) => JSX.Element | null) & {
  PageWrapper?: (props: AppProps) => JSX.Element;
};

const SingleAppPage: SingleAppPageComponentFunction = function (props: inferSSRProps<typeof getStaticProps>) {
