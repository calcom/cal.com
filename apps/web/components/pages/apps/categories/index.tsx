...
type CategoriesPageComponentFunction = {
  ({ categories }: Omit<inferSSRProps<typeof getServerSideProps>, "trpcState">): JSX.Element;
  PageWrapper?: (props: AppProps) => JSX.Element;
};

const Apps: CategoriesPageComponentFunction = function Apps({
  categories,
