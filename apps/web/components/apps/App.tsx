  ...
  return (
    <div className="relative flex-1 flex-col items-start justify-start px-4 md:flex md:px-8 lg:flex-row lg:px-0">
      ...
      <div
        ...
        <h4 className="text-emphasis mb-2 mt-8 font-semibold ">{t("learn_more")}</h4>
          ...
          {docs && (
            <li>
              <a
                ...
                href={docs}>
                <FiBookOpen className="text-subtle -mt-1 mr-1 inline h-4 w-4" />
                {t("documentation")}
              </a>
            </li>
          )}
          {website && (
            <li>
              <a
                ...
                href={website}>
                <FiExternalLink className="text-subtle -mt-px mr-1 inline h-4 w-4" />
          ...
          {email && (
            <li>
              <a
                ...
                className="text-emphasis font-normal no-underline hover:underline"
                href={"mailto:" + email}>
                <FiMail className="text-subtle -mt-px mr-1 inline h-4 w-4" />
          ...
          {tos && (
            <li>
              <a
                ...
                className="text-emphasis font-normal no-underline hover:underline"
                href={tos}>
                <FiFile className="text-subtle -mt-px mr-1 inline h-4 w-4" />
                {t("terms_of_service")}
              </a>
            </li>
          )}
          {privacy && (
            <li>
              <a
                ...
                className="text-emphasis font-normal no-underline hover:underline"
                href={privacy}>
                <FiShield className="text-subtle -mt-px mr-1 inline h-4 w-4" />
                {t("privacy_policy")}
              </a>
            </li>
          )}
