...
type LocationsProps = {
  eventType: Omit<TEventType, "selected" | "locationOptions" | "URL" | "position">;
  team: { id: number } | null;
...
} & Pick<EventTypeSetupProps, "locationOptions">;
...
const Locations: React.FC<LocationsProps> = ({
  ...
  eventType,
  isChildrenManagedEventType = true,
  isManagedEventType = true,
  disableLocationProp = true,
  ...props
}) => {
  ...
  const defaultValue = isManagedEventType
    ? props.locationOptions.find((op) => op.label === t("default"))?.options[0]
    : undefined;
                ...
                <LocationSelect
                  ...
                  onChange={(e: SingleValueLocationOption) => {
                    ...
                    if (e?.value) {
                      ...
                      console.log("existingBookingFields: ", existingBookingFields);
