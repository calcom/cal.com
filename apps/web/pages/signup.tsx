  ...
  return (
    <div
      className={classNames(
        "light bg-muted 2xl:bg-default flex min-h-screen w-full flex-col items-center justify-center [--cal-brand-emphasis:#101010] [--cal-brand-text:#FFFFFF] [--cal-brand-subtle:#9CA3AF]  dark:[--cal-brand-emphasis:#e1e1e1] dark:[--cal-brand-text:#000000] dark:[--cal-brand:#FFFFFF]",
        "[--cal-brand:#111827]"
      )}>
