...
import { PeriodType, SchedulingType, SchedulingMethod } from "@prisma/client";
...
const EventTypePage = (props: EventTypeSetupProps) => {
  ...
  const formMethods = useForm<FormValues>({
    defaultValues: {
      ...
      schedulingMethod: eventType.schedulingMethod || SchedulingMethod.OPTIMIZE_AVAILABILITY,
      metadata,
