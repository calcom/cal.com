...
import { OAuthClientForm } from "@components/settings/platform/oauth-clients/OAuthClientForm";
          ...
          <div className="border-subtle mx-auto block justify-between rounded-t-lg border px-4 py-6 sm:flex sm:px-6">
            <div className="flex w-full flex-col">
              ...
              <p className="text-default text-sm ltr:mr-4 rtl:ml-4">
                This is the form to {!!clientId ? "to update an" : "to create a new "} OAuth client
              </p>
            </div>
          </div>
