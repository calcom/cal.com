...
import { enabledIncompleteBookingApps } from "@calcom/features/routing-forms/lib/enabledIncompleteBookingApps";
...
IncompleteBookingPage.getLayout = getLayout;
IncompleteBookingPage.PageWrapper = PageWrapper;
