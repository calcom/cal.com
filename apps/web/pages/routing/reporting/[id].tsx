...
import type { JsonLogicQuery } from "@calcom/features/routing-forms/jsonLogicToPrisma";
import {
...
ReporterWrapper.getLayout = getLayout;
ReporterWrapper.PageWrapper = PageWrapper;
