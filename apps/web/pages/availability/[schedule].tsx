...
import { FiInfo, FiMoreHorizontal, FiPlus, FiTrash } from "@calcom/ui/components/icon";
    ...
    <Shell
      ...
      CTA={
        <div className="flex items-center justify-end">
          <div className="flex hidden items-center rounded-md px-2 sm:flex sm:hover:bg-gray-100">
          ...
          <Dropdown>
            <DropdownMenuTrigger asChild>
              <Button className="sm:hidden" StartIcon={FiMoreHorizontal} variant="icon" color="secondary" />
            </DropdownMenuTrigger>
