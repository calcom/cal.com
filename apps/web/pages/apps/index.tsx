...
export default function Apps() {
  ...
  >([]);
  const [appStore, setAppStore] = useState<AppFrontendPayload[]>([]);
  const [userAdminTeams, setUserAdminTeams] = useState<UserAdminTeams>([]);
  ...
  useEffect(() => {
    fetch("/api/apps")
      ...
      .then((data) => {
        ...
        setUserAdminTeams(data.userAdminTeams);
      })
      .catch((error) => {
