...
import { DEFAULT_EVENT_TYPES } from "app/ee/event-types/event-types_2024_04_15/constants/constants";
import { HttpExceptionFilter } from "app/filters/http-exception.filter";
import { PrismaExceptionFilter } from "app/filters/prisma-exception.filter";
import { Locales } from "app/lib/enums/locales";
import {
  CreateUserResponse,
  UserReturned,
} from "app/modules/oauth-clients/controllers/oauth-client-users/oauth-client-users.controller";
import { CreateManagedUserInput } from "app/modules/users/inputs/create-managed-user.input";
