...
import { CreateEventTypeOutput_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/outputs/create-event-type.output";
import { DeleteEventTypeOutput_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/outputs/delete-event-type.output";
import { GetEventTypeOutput_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/outputs/get-event-type.output";
import { GetEventTypesOutput_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/outputs/get-event-types.output";
import { UpdateEventTypeOutput_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/outputs/update-event-type.output";
import { EventTypesService_2024_06_14 } from "app/ee/event-types/event-types_2024_06_14/services/event-types.service";
import { VERSION_2024_06_14_VALUE } from "app/lib/api-versions";
import { GetUser } from "app/modules/auth/decorators/get-user/get-user.decorator";
import { Permissions } from "app/modules/auth/decorators/permissions/permissions.decorator";
import { ApiAuthGuard } from "app/modules/auth/guards/api-auth/api-auth.guard";
import { PermissionsGuard } from "app/modules/auth/guards/permissions/permissions.guard";
