...
import { Frequency } from "@/platform/event-types/event-types_2024_04_15/inputs/enums/frequency";
...
export class UpdateEventTypeInput_2024_04_15 {
  ...
  // @IsEnum(PeriodType)
  // @IsOptional()
  // periodType?: PeriodType; -> import { PeriodType } from "@/platform/event-types/inputs/enums/period-type";
  ...
  // @IsOptional()
  // schedulingType?: SchedulingType; -> import { SchedulingType } from "@/platform/event-types/inputs/enums/scheduling-type";
