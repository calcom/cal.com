...
export class BookingsController_2024_08_13 {
  ...
  @ApiOperation({
    ...
    description: `\`:bookingUid\` can be
      ...
      you have to provide an authentication method of event type owner, host, team admin or owner or org admin or owner in order to bypass the 'show attendees' event-type setting.
      `,
  })
  async getBooking(
