...
import { BookingFieldValidator, eventTypeBookingFieldsSchema } from "@/ee/bookings/2024-08-13/services/booking-field.validator";
...
export class BookingsService_2024_08_13 {
  ...
  constructor(
    ...
    private readonly bookingFieldValidator: BookingFieldValidator
  ) { }
  ...
  async hasRequiredBookingFieldsResponses(body: CreateBookingInput, eventType: EventType | null) {
    ...
    const eventTypeBookingFields = eventTypeBookingFieldsSchema.parse(eventType.bookingFields);
    this.bookingFieldValidator.validateAll(eventTypeBookingFields, bookingFieldsResponses);
