...
export class CreatePhoneCallInput {
  ...
  @IsBoolean()
  @IsOptional()
  @ApiPropertyOptional({ description: "Enabled status", default: true })
  enabled = true;

  @IsEnum(TemplateType)
  @IsOptional()
  @ApiPropertyOptional({ description: "Template type", enum: TemplateType, default: TemplateType.CUSTOM_TEMPLATE })
