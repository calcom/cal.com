...
export class CreateUserInput {
  ...
  @ApiPropertyOptional({ type: String, description: "Preferred weekday", example: "Monday" })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ type: Boolean, description: "Hide branding", example: false })
  @IsOptional()
  @IsBoolean()
  @Expose()
  hideBranding?: boolean;

  @ApiPropertyOptional({ type: String, description: "Time zone", example: "America/New_York" })
  @IsOptional()
  @IsString()
  @CapitalizeTimeZone()
  ...
  @ApiPropertyOptional({ type: String, description: "Theme", example: "dark" })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ type: String, description: "Application theme", example: "light" })
  @IsOptional()
  @IsString()
  @Validate(ThemeValidator)
  @Expose()
  ...
  @ApiPropertyOptional({ type: Number, description: "Time format", example: 24 })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({ type: Number, description: "Default schedule ID", example: 1, minimum: 0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Expose()
  ...
  @ApiPropertyOptional({ type: String, description: "Locale", example: "en", default: "en" })
  @IsOptional()
  @IsString()
