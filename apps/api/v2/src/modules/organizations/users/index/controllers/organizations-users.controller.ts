...
export class OrganizationsUsersController {
  ...
  @ApiOperation({
    ...
    description:
      "Required membership role: `org admin`. PBAC permission: `organization.editUsers`. Learn more about API access control at https://cal.com/docs/api-reference/v2/access-control",
  })
