...
export class OrganizationAttributeOptionService {
    constructor(private readonly organizationAttributeOptionRepository: OrganizationAttributeOptionRepository) {}
    ...
    async createOrganizationAttributeOption(organizationId: number, attributeId: string, data: CreateOrganizationAttributeOptionInput) {
        return this.organizationAttributeOptionRepository.createOrganizationAttributeOption(organizationId, attributeId, data);
    }

    async deleteOrganizationAttributeOption(organizationId: number, attributeId: string, optionId: string) {
        return this.organizationAttributeOptionRepository.deleteOrganizationAttributeOption(organizationId, attributeId, optionId);
    }
    ...
    async updateOrganizationAttributeOption(organizationId: number, attributeId: string, optionId: string, data: UpdateOrganizationAttributeOptionInput) {
        return this.organizationAttributeOptionRepository.updateOrganizationAttributeOption(organizationId, attributeId, optionId, data);
    }

    async getOrganizationAttributeOptions(organizationId: number, attributeId: string) {
        return this.organizationAttributeOptionRepository.getOrganizationAttributeOptions(organizationId, attributeId);
    }
    ...
    async assignOrganizationAttributeOptionToUser(organizationId: number, userId: number, attributeId: string, data: AssignOrganizationAttributeOptionToUserInput) {
        return this.organizationAttributeOptionRepository.assignOrganizationAttributeOptionToUser(organizationId, userId, attributeId, data);
    }

    async unassignOrganizationAttributeOptionFromUser(organizationId: number, userId: number, attributeOptionId: string) {
        return this.organizationAttributeOptionRepository.unassignOrganizationAttributeOptionFromUser(organizationId, userId, attributeOptionId);
    }
