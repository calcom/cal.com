...
type BaseAvailableSlotsDeps = ConstructorParameters<typeof BaseAvailableSlotsService>[0];
  ...
  constructor(
    ...
    super({
      ...
      qualifiedHostsService:
        qualifiedHostsService as unknown as BaseAvailableSlotsDeps["qualifiedHostsService"],
