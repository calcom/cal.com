...
/**
 * @swagger
 * /bookings/uid/{id}/cancel:
 *   delete:
 *     summary: Booking cancellation
 *     operationId: cancelBookingByUid
 *
 *     parameters:
 *      - in: path
 *        name: id
...
async function handler(req: NextApiRequest) {
  const { id, allRemainingBookings, cancellationReason } = schemaQueryIdAsString
  ...
  req.body = { uid: id, allRemainingBookings, cancellationReason };
