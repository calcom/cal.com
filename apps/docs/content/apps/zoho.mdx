...
10. **Integration is Ready** - Your ZohoCRM integration can now be easily added in the Cal.diy settings.
...
5. **Save Credentials in Cal.diy Admin Panel** - Copy the Client ID and Client Secret to your app keys in the Cal.diy admin panel at:
...
7. **Complete Zoho Bigin Integration** - Your Zoho Bigin integration is now ready and can be added from the Cal.diy app store.
