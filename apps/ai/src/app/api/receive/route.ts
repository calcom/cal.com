...
export const POST = async (request: NextRequest) => {
  ...
  // User is using an unverified email.
  if (!signature) {
    await sendEmail({
      html: `Thanks for your interest in Cal.ai! It looks like you're using an unverified email. Please make sure you're sending from a dkim verified email address and try again.`,
      subject: `Re: ${subject}`,
      text: `Thanks for your interest in Cal.ai! It looks like you're using an unverified email. Please make sure you're sending from a dkim verified email address and try again.`,
      to: envelope.from,
      from: aiEmail,
    });
