...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<Cal.com URL>/api/auth/callback/google` replacing Cal.com URL with the URI at which your application runs.
